...
| [IsValidHostId](f294365b-5eee-57c0-ad6a-cbdd7bd7637f.md "IsValidHostId Method") | Indicates if the provided host id can host line loads The document containing both the host and the load The id of the analytical panel that is about to host a line load True if a line load can be placed on the input host id |
