# MassEnergyAnalyticalModel Members (2023)
...
[MassEnergyAnalyticalModel Class](1e8b2837-0572-d788-a6eb-db5060fc423c.md "MassEnergyAnalyticalModel Class") Methods Properties See Also  
---  
The [MassEnergyAnalyticalModel](1e8b2837-0572-d788-a6eb-db5060fc423c.md "MassEnergyAnalyticalModel Class") type exposes the following members.
# Methods
| Name | Description |
| --- | --- |
| --- | --- | --- |
...
| [GetCoincidentEnergyAnalyticalModelFaceReference](3aafd0ed-d439-3c4e-ce26-a3b63a279361.md "GetCoincidentEnergyAnalyticalModelFaceReference Method") | Returns a Reference to a Face from the same or a different MassEnergyAnalyticalModel that is coincident with the input Face. |
| [GetCoincidentMassZoneFaceReferences](5b1e9dee-f52a-03ad-af80-733c7b9866eb.md "GetCoincidentMassZoneFaceReferences Method") | Returns References to Faces from MassZones coincident with an input Face from a MassEnergyAnalyticalModel. |
...
| [GetJoinedMassEnergyAnalyticalModelElementIds](bba7fcf9-074f-7503-5986-5aceb80844ad.md "GetJoinedMassEnergyAnalyticalModelElementIds Method") | The ElementIds of other MassEnergyAnalyticalModels that are "joined" to this one. |
| [GetMassEnergyAnalyticalModelIdForMassInstance](3b9c5835-a3a7-8d7c-3eb3-34e4d03d7dff.md "GetMassEnergyAnalyticalModelIdForMassInstance Method") | Get the ElementId of the MassEnergyAnalyticalModel for a mass instance. |
| [GetMassSurfaceDataIdForReference](043322a9-ce60-c27c-9230-5945e84d9e87.md "GetMassSurfaceDataIdForReference Method") | Get the ElementId of the MassSurfaceData corresponding to the Reference. |
| [GetMassZoneIds](ea919b80-4905-dfac-dfd8-b7db36ae055b.md "GetMassZoneIds Method") | Get the MassZone ElementIds that are created from this MassEnergyAnalyticalModel. |
...
| [GetReferencesToAllFaces](f0251c4c-8c8f-d528-2199-28eddfdfaa2a.md "GetReferencesToAllFaces Method") | Get References to all Faces which are meaningful for the MassEnergyAnalyticalModel. Array of References to Faces of the MassEnergyAnalyticalModel. |
| [GetReferencesToAllShadingFaces](bfdd7023-441d-9625-62c2-7704fe80f845.md "GetReferencesToAllShadingFaces Method") | Get References to all Faces of the MassEnergyAnalyticalModel which are of Mass Shade subcategory. |
...
| [GetValidSurfaceCategoryIdsForReference](91d6eed8-f2f2-4028-f8a6-24306c540387.md "GetValidSurfaceCategoryIdsForReference Method") | The Mass surface subcategory ids that are appropriate values for the input Reference. |
...
| [MassId](51759ce5-c19f-1ee4-8e71-bd0574347d5e.md "MassId Property") | The ElementId of the mass instance the MassEnergyAnalyticalModel is associated with. |
| [MassZoneCoreOffset](aa87711c-617d-a833-06a0-5d7134666e65.md "MassZoneCoreOffset Property") | If this value is greater than 0.0, in the MassEnergyAnalytical model a building "core" geometry will be created for each solid geometry of the mass instance. |
