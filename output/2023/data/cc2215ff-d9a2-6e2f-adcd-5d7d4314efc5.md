# FloorMightLookWrong Property (2023)
...
---  
```text
Public Shared ReadOnly Property FloorMightLookWrong As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ FloorMightLookWrong {
