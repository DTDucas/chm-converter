...
---  
DirectShape Members  
[DirectShape Class](bfbd137b-c2c2-71bb-6f4a-992d0dcf6ea8.md "DirectShape Class") Methods Properties See Also  
---  
...
| --- | --- |
| --- | --- | --- |
| [AddExternallyTaggedGeometry](2c551429-8b90-ed46-3e29-a6b3dbc1cb95.md "AddExternallyTaggedGeometry Method") | Adds the externally tagged geometry object to the DirectShape. |
...
| [AreOptionsValid](d613f35a-83ad-cc32-25a9-449b9ba04723.md "AreOptionsValid Method") | Validates that the given DirectShapeOptions are allowed for this particular DirectShape. |
| [AreOptionsValidForTransientDirectShape](83b95bbf-6e6d-25ab-053b-441447ac389f.md "AreOptionsValidForTransientDirectShape Method") | Validates that the given DirectShapeOptions are allowed if this DirectShape is transient. |
...
| [CanCreateParts](00584d60-2960-36ab-f305-d2f4dda220f8.md "CanCreateParts Method") | Indicates if it is possible to create parts from this DirectShape element. |
...
| [CreateElement](bee8a24f-704e-44d9-e187-9e031548a6d2.md "CreateElement Method") | Creates a DirectShape object and adds it to document. |
| [CreateElementInstance](2a44c4e3-5056-eb56-f849-a7e9dcc478da.md "CreateElementInstance Method") | Creates a DirectShape object and adds it to document. |
| [CreateGeometryInstance](8a5a08cc-14ea-9c69-26b4-5f1b0562bf53.md "CreateGeometryInstance Method") | Creates a copy of a definition shape that was created earlier. |
...
| [GetExternallyTaggedGeometry](a32792d0-1633-37c5-6ed0-02bdb9b6c4b5.md "GetExternallyTaggedGeometry Method") | Gets the externally tagged geometry by its external ID that is stored in this DirectShape. |
...
| [GetOptions](2bc77946-040e-7c75-0258-373adb8d2966.md "GetOptions Method") | Gets a copy of the current options for this DirectShape. |
...
| [HasExternalGeometry](e17297d9-8bc9-2408-515d-2e9058e4fb5c.md "HasExternalGeometry Method") | Checks whether the externally tagged geometry is already present in this DirectShape. |
...
| [IsSupportedDocument](8651e9ac-f5cf-840b-d271-c8db2a244377.md "IsSupportedDocument Method") | Tests whether a DirectShape or a DirectShapeType may be created in this document. |
| [IsValidCategoryId](c8881d31-d410-842a-1375-5ba688191cf8.md "IsValidCategoryId Method") | Test the category id to make sure the category is allowed for a DirectShape or DirectShapeType. |
| [IsValidGeometry](bd083561-a6e1-605e-14ce-cfe07598f3f6.md "IsValidGeometry Method") | Validates geometry to be stored in a DirectShape. Suitable geometry validation is performed. Additionally, the geometry must make sense as a shape representation for the category assigned to this DirectShape object. |
| [IsValidReferenceCurve](af56ade3-831a-b432-c39e-bafbfed03e63.md "IsValidReferenceCurve Method") | Validates that the input curve is suitable for creating a direct shape reference curve. Bounded and unbounded lines are accepted. Other bounded and unbounded curve types with natural bounds are accepted if they are not closed. Unbounded periodic curves are not allowed. |
| [IsValidReferencePlaneBoundingBoxUV](fa8aa1c6-5bf2-ee0f-c264-509e53ac05b2.md "IsValidReferencePlaneBoundingBoxUV Method") | Validates that the input BoundingBoxUV is suitable for bounding a reference plane surface. The input BoundingBoxUV must be set and not degenerate. |
...
| [RemoveExternallyTaggedGeometry](f25a46b4-5eb7-f503-1599-bfb3b549d632.md "RemoveExternallyTaggedGeometry Method") | Removes the externally tagged geometry object by its external ID from this DirectShape. |
| [ResetExternallyTaggedGeometry](c209aeeb-03c9-9dbb-6b85-dd7e26188c5c.md "ResetExternallyTaggedGeometry Method") | Removes all of the externally tagged geometry in this DirectShape. |
...
| [SetName](9ff002c5-3197-9feb-bd85-a497ad2c6f14.md "SetName Method") | Sets the name for the DirectShape element. |
| [SetOptions](a7163c75-af77-624c-ca60-e5271827c03f.md "SetOptions Method") | Sets the options to use for this DirectShape. |
...
| [SetTypeId](077e58a6-977e-be35-6e20-dd07daa1fdd0.md "SetTypeId Method") | Sets the DirectShapeType for the DirectShape element. |
| ToString | Returns a string that represents the current object. (Inherited from Object.) |
| [UpdateExternallyTaggedGeometry](c15c6964-0514-7c53-fdf0-9900ec68636f.md "UpdateExternallyTaggedGeometry Method") | Updates the externally tagged geometry object in the DirectShape. |
