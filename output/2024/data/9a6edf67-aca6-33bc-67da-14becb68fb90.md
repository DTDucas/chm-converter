# NoColumnsJoinedToGridLines Property (2024)
...
---  
```text
Public Shared ReadOnly Property NoColumnsJoinedToGridLines As FailureDefinitionId
	Get
```
...
```text
public:
static property FailureDefinitionId^ NoColumnsJoinedToGridLines {
