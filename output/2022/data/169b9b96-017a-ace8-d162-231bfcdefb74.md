...
Revit 2022 API  
---  
AnalyticalModelStick..::..GetProjectionZ Method   
...
---  
```text
public StickElementProjectionZ GetProjectionZ(
...
---  
```text
Public Function GetProjectionZ ( _
	selector As AnalyticalElementSelector _
) As StickElementProjectionZ
```
...
```text
public:
StickElementProjectionZ GetProjectionZ(
	AnalyticalElementSelector selector
)
```
