# BottomExtensionMethod Property (2022)
...
Revit 2022 API  
---  
AnalyticalModelSurface..::..BottomExtensionMethod Property   
...
---  
```text
public AnalyticalAlignmentMethod BottomExtensionMethod { get; set; }
```
  
Visual Basic  
---  
```text
Public Property BottomExtensionMethod As AnalyticalAlignmentMethod
	Get
	Set
```
...
```text
public:
property AnalyticalAlignmentMethod BottomExtensionMethod {
