# AnalyticalModelAutoCheckMemberSupports Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelAutoCheckMemberSupports Property   
...
---  
```text
public bool AnalyticalModelAutoCheckMemberSupports { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelAutoCheckMemberSupports As Boolean
	Get
	Set
```
...
```text
public:
property bool AnalyticalModelAutoCheckMemberSupports {
	bool get ();
	void set (bool value);
}
```
