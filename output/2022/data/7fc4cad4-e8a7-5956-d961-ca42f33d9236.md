# TopographySurface Members (2022)
...
| --- | --- |
| --- | --- | --- |
| [AddPoints](d918a387-2f34-5ed8-6b56-b690ca756320.md "AddPoints Method") | Adds points to a topography surface. |
...
| [ChangePointElevation](6433254d-a875-0253-def2-e0573639af3e.md "ChangePointElevation Method") | Changes the elevation value for a point. |
| [ChangePointsElevation](099b30df-e4c9-fe81-6a32-6a55b57994a6.md "ChangePointsElevation Method") | Changes the elevation value for points |
...
| [Create(Document, IList<(Of <<'(XYZ>)>>))](824b6a30-f775-149f-2e6a-5198c5299d14.md "Create Method \(Document, IList\(XYZ\)\)") | Creates a new topography surface element and adds it to the document. |
| [Create(Document, IList<(Of <<'(XYZ>)>>), IList<(Of <<'(PolymeshFacet>)>>))](5fa47ddd-7dbd-ae8a-69bc-9e260ec56d99.md "Create Method \(Document, IList\(XYZ\), IList\(PolymeshFacet\)\)") | Creates a new topography surface element from facets and adds it to the document. |
...
| [DeletePoints](06206e0f-db70-d184-1f13-d9a787e8fd98.md "DeletePoints Method") | Deletes points from a Topography surface. |
...
| [MovePoint](3068f86b-519e-55b4-f571-26ed441f3836.md "MovePoint Method") | Moves a point in a TopographySurface to a new designated location. |
| [MovePoints](189b0ff1-9666-b875-eeb9-dbd12dc5013f.md "MovePoints Method") | Moves a collection of points in a topography surface by a designated vector. |
