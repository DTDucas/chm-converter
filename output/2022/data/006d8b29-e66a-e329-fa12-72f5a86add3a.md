# GetAlignmentMethod Method (2022)
...
---  
```text
public AnalyticalAlignmentMethod GetAlignmentMethod(
...
---  
```text
Public Function GetAlignmentMethod ( _
	selector As AnalyticalElementSelector _
) As AnalyticalAlignmentMethod
```
...
```text
public:
AnalyticalAlignmentMethod GetAlignmentMethod(
	AnalyticalElementSelector selector
)
```
