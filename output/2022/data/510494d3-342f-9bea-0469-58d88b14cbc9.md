# CheckAnalyticalModelAsset Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..CheckAnalyticalModelAsset Property   
...
---  
```text
public bool CheckAnalyticalModelAsset { get; set; }
```
  
Visual Basic  
---  
```text
Public Property CheckAnalyticalModelAsset As Boolean
	Get
	Set
```
...
```text
public:
property bool CheckAnalyticalModelAsset {
	bool get ();
	void set (bool value);
}
```
