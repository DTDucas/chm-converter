...
Revit 2022 API  
---  
Document..::..NewFoundationSlab Method   
...
normal
    Type: [Autodesk.Revit.DB..::..XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md "XYZ Class") A vector that must be perpendicular to the profile which dictates which side of the floor is considered to be upper and down. 
# ### Return Value
if successful, a new foundation slab object within the project, otherwise nullNothingnullptra null reference (Nothing in Visual Basic). 
# Remarks
