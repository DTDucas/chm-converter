...
| [GetLeaderElbow](cb3f9617-d5a4-7c45-1686-d7c2f60effad.md "GetLeaderElbow Method") | Returns the position of the elbow of the tag's leader that points to specified reference. |
...
| [GetTaggedLocalElement](d8d951a5-80cb-04c7-2b16-e16ff608c1e2.md "GetTaggedLocalElement Method") | **Obsolete.** Get the tagged local element, if any. If the tag is tagged on a subelement of local element, it returns the element. |
| [GetTaggedLocalElementIds](142026b1-69d5-7b1e-f5b3-3360abc0f9be.md "GetTaggedLocalElementIds Method") | Returns a set of IDs for all tagged local elements, if any. A local element ID will be provided for each subelement that is being referenced by the tag. |
...
| [GetTaggedReference](7e29406f-b548-d4c8-22ed-82d8d781afc1.md "GetTaggedReference Method") | **Obsolete.** Get the host reference of the tag. |
| [GetTaggedReferences](63a90870-6b37-57b2-26fe-6fa1e605a9da.md "GetTaggedReferences Method") | Get the host references of the tag. |
...
| [IsTaggedOnSubelement](8f6f8b8c-1b1b-1141-e165-1eecd4b765a1.md "IsTaggedOnSubelement Method") | Returns true if the tag is tagged on a subelement. |
...
| [HasElbow](2d2158d8-a749-c36e-8f4e-f000ffb898ac.md "HasElbow Property") | **Obsolete.** Whether the tag's leader has an elbow point or not. |
| [HasLeader](ce3fe3a9-4048-3b29-4dcb-57ca86de4267.md "HasLeader Property") | Whether the tag has a leader or not. |
...
| [LeaderElbow](3c2a5131-494a-b4e8-cb4b-7fc7ab67e7ed.md "LeaderElbow Property") | **Obsolete.** The position of the elbow of the tag's leader. |
| [LeaderEnd](5d181279-1b4e-b199-62cc-3a3d58d797a3.md "LeaderEnd Property") | **Obsolete.** The position of the leader end for a tag using free end leader behavior. |
...
| [TaggedElementId](12ff75b5-2893-dee9-7321-85c3439e40f7.md "TaggedElementId Property") | **Obsolete.** The LinkElementId of the tagged element, if any. If the tag is tagged on a subelement of linked element, it returns the LinkElementId of the element. |
| [TaggedLocalElementId](759306d1-5168-ef9a-91e4-494c7eff0b5d.md "TaggedLocalElementId Property") | **Obsolete.** The ID of the tagged local element, if any. If the tag is tagged on a subelement of local element, it returns the element ID. |
