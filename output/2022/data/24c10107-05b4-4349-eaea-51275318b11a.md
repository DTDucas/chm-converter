# AnalyticalModelCheckCircularReferences Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelCheckCircularReferences Property   
...
---  
```text
public bool AnalyticalModelCheckCircularReferences { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelCheckCircularReferences As Boolean
	Get
	Set
```
...
```text
public:
property bool AnalyticalModelCheckCircularReferences {
	bool get ();
	void set (bool value);
}
```
