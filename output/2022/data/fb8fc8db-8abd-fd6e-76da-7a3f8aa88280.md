# AnalyticalLinkAutofixTolerance Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalLinkAutofixTolerance Property   
...
---  
```text
public double AnalyticalLinkAutofixTolerance { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalLinkAutofixTolerance As Double
	Get
	Set
```
...
```text
public:
property double AnalyticalLinkAutofixTolerance {
	double get ();
