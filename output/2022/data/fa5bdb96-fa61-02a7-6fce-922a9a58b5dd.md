# AnalyticalModelHorizontalAutofixTolerance Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelHorizontalAutofixTolerance Property   
...
---  
```text
public double AnalyticalModelHorizontalAutofixTolerance { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelHorizontalAutofixTolerance As Double
	Get
	Set
```
...
```text
public:
property double AnalyticalModelHorizontalAutofixTolerance {
	double get ();
