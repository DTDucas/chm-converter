# AnalyticalModelCheckBeamSlabDistance Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelCheckBeamSlabDistance Property   
...
---  
```text
public bool AnalyticalModelCheckBeamSlabDistance { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelCheckBeamSlabDistance As Boolean
	Get
	Set
```
...
```text
public:
property bool AnalyticalModelCheckBeamSlabDistance {
	bool get ();
	void set (bool value);
}
```
