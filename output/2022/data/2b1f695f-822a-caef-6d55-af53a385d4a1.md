...
Revit 2022 API  
---  
AnalyticalModel..::..GetAnalyzeAs Method   
...
---  
```text
Public Function GetAnalyzeAs As AnalyzeAs
```
...
```text
public:
AnalyzeAs GetAnalyzeAs()
```
  
# ### Return Value
AnalyzeAs enumeration, indicating how Analytical Model is analyzed. 
# See Also
