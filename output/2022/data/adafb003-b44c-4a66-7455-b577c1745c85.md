# AnalyticalModelDiscrepancyTolerance Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelDiscrepancyTolerance Property   
...
---  
```text
public double AnalyticalModelDiscrepancyTolerance { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelDiscrepancyTolerance As Double
	Get
	Set
```
...
```text
public:
property double AnalyticalModelDiscrepancyTolerance {
	double get ();
