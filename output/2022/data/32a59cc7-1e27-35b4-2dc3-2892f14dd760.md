# PromptToPlaceViewOnSheet Method (2022)
...
This method can't be used to place a schedule on a sheet. Use [Create(Document, ElementId, ElementId, XYZ)](8402dc3c-8bdc-40f5-be54-da08bc69d0cd.md "Create Method") to add schedules to sheets. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
