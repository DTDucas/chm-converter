# GetExternallyTaggedGeometry Method (2022)
...
# ### Return Value
The externally tagged geometry. Or nullNothingnullptra null reference (Nothing in Visual Basic) if there is no such an externally tagged geometry in the DirectShapeType. 
# Exceptions
| Exception | Condition |
| --- | --- |
| --- | --- |
