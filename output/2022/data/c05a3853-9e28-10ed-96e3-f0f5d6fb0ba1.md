# DifferentiateAnalyticalEnds Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..DifferentiateAnalyticalEnds Property   
[StructuralSettings Class](1d1b89be-c2ae-ca39-01ce-f5b01178fb1e.md "StructuralSettings Class") See Also  
---  
Whether to use a subcategory for the ends of a linear analytical model, rather than the main category. 
...
---  
```text
public bool DifferentiateAnalyticalEnds { get; set; }
```
  
Visual Basic  
---  
```text
Public Property DifferentiateAnalyticalEnds As Boolean
	Get
	Set
```
...
```text
public:
property bool DifferentiateAnalyticalEnds {
	bool get ();
	void set (bool value);
}
```
