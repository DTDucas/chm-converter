# AnalyticalModelCheckInstability Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelCheckInstability Property   
...
---  
```text
public bool AnalyticalModelCheckInstability { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelCheckInstability As Boolean
	Get
	Set
```
...
```text
public:
property bool AnalyticalModelCheckInstability {
	bool get ();
	void set (bool value);
}
```
