# SupportsManualAdjustment Method (2022)
...
Revit 2022 API  
---  
AnalyticalModel..::..SupportsManualAdjustment Method   
...
---  
```text
Public Function SupportsManualAdjustment As Boolean
```
...
```text
public:
bool SupportsManualAdjustment()
```
  
# ### Return Value
True if Manual Adjustment is possible, false otherwise. 
# See Also
