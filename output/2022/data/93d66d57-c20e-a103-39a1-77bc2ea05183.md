# Export Method (String, IList(ElementId), PDFExportOptions) (2022)
...
| --- | --- |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md "ArgumentException Class") | non empty list of views must be provided. -or- NullOrEmpty -or- There comes duplicated views in viewIds -or- some of the views are not printable (exportable). -or- Thrown when one or more input arguments are invalid. |
