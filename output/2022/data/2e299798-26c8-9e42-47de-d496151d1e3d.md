# Create Method (Document, AnalyticalModelSurface, Int32, XYZ, XYZ, LineLoadType) (2022)
...
Revit 2022 API  
---  
LineLoad..::..Create Method (Document, AnalyticalModelSurface, Int32, XYZ, XYZ, LineLoadType)  
...
host
    Type: [Autodesk.Revit.DB.Structure..::..AnalyticalModelSurface](8c656a67-d41d-c5e5-f75a-554173dfcdd9.md "AnalyticalModelSurface Class") The analytical model surface host element for the line Load. 
curveIndex
    Type: System..::..Int32 The index of a curve in analytical surface element starting from 0. Use [!:Autodesk::Revit::DB::Structure::AnalyticalModelSurface::GetLoops(Autodesk::Revit::DB::Structure::AnalyticalLoopType::All)] method to obtain appropriate curve index. Curve index has a unique value in analytical surface element even if it contains more than one loop. The index should be obtain by iteration through all curves in all loops. 
forceVector1
