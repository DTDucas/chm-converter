...
Revit 2022 API  
---  
AnalyticalModelStick..::..GetProjectionY Method   
...
---  
```text
public StickElementProjectionY GetProjectionY(
...
---  
```text
Public Function GetProjectionY ( _
	selector As AnalyticalElementSelector _
) As StickElementProjectionY
```
...
```text
public:
StickElementProjectionY GetProjectionY(
	AnalyticalElementSelector selector
)
```
