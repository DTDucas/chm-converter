# AnalyticalModelAutoCheckConsistency Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelAutoCheckConsistency Property   
[StructuralSettings Class](1d1b89be-c2ae-ca39-01ce-f5b01178fb1e.md "StructuralSettings Class") See Also  
---  
Whether to check automatically for consistency between the analytical and physical models. 
...
---  
```text
public bool AnalyticalModelAutoCheckConsistency { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelAutoCheckConsistency As Boolean
	Get
	Set
```
...
```text
public:
property bool AnalyticalModelAutoCheckConsistency {
	bool get ();
	void set (bool value);
}
```
