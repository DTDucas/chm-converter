# AnalyticalModelVerticalAutofixTolerance Property (2022)
...
Revit 2022 API  
---  
StructuralSettings..::..AnalyticalModelVerticalAutofixTolerance Property   
...
---  
```text
public double AnalyticalModelVerticalAutofixTolerance { get; set; }
```
  
Visual Basic  
---  
```text
Public Property AnalyticalModelVerticalAutofixTolerance As Double
	Get
	Set
```
...
```text
public:
property double AnalyticalModelVerticalAutofixTolerance {
	double get ();
