...
---  
    ...
    public UpdaterId(
    	[AddInId](31859d69-72c7-03fb-83e1-5c7719dca253.md) addInId,
    	Guid val
    )  
...
---  
    ...
    Public Sub New ( _
    	addInId As [AddInId](31859d69-72c7-03fb-83e1-5c7719dca253.md), _
    	val As Guid _
    )  
...
addInId
    Type: [Autodesk.Revit.DB..::..AddInId](31859d69-72c7-03fb-83e1-5c7719dca253.md) Id of addin that registers an Updater 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | addInId is not valid. |
