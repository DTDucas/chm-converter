...
---  
    ...
    public void SetPreferredConstraintForHandle(
    	...
    	[RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md) constraint
    )  
...
---  
    ...
    Public Sub SetPreferredConstraintForHandle ( _
    	...
    	constraint As [RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md) _
    )  
...
handle
    Type: [Autodesk.Revit.DB.Structure..::..RebarConstrainedHandle](08b4c4a3-3bb9-0801-9cc8-cd5420a306d9.md) The RebarConstrainedHandle to which the new RebarConstraint is to be applied. 

constraint
    Type: [Autodesk.Revit.DB.Structure..::..RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md) The new RebarConstraint to be applied to the RebarConstrainedHandle. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | constraint is no longer valid. -or- handle is no longer valid. |
