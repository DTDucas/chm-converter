...
---  
    ...
    public static bool CheckBuildingHVACSystem(
    	[gbXMLBuildingHVACSystem](33ed4d48-c47a-6f56-dd22-ddfc4ad87519.md) buildingHVACSystem
    )  
...
---  
    ...
    Public Shared Function CheckBuildingHVACSystem ( _
    	buildingHVACSystem As [gbXMLBuildingHVACSystem](33ed4d48-c47a-6f56-dd22-ddfc4ad87519.md) _
    ) As Boolean  
...
buildingHVACSystem
    Type: [Autodesk.Revit.DB.Analysis..::..gbXMLBuildingHVACSystem](33ed4d48-c47a-6f56-dd22-ddfc4ad87519.md) The building HVAC system to be checked. 
