...
---  
    ...
    public FieldBuilder(
    	[FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md) other
    )  
...
---  
    ...
    Public Sub New ( _
    	other As [FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md) _
    )  
...
other
    Type: [Autodesk.Revit.DB.ExtensibleStorage..::..FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md)
