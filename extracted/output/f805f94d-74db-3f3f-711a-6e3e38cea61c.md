...
---  
    ...
    public [ConnectorElement](cd7d7579-1058-e8ca-d55a-c3a914843667.md) GetLinkedConnectorElement()  
  
Visual Basic  
---  
      
    
    Public Function GetLinkedConnectorElement As [ConnectorElement](cd7d7579-1058-e8ca-d55a-c3a914843667.md)  
...
---  
    ...
    public:
    [ConnectorElement](cd7d7579-1058-e8ca-d55a-c3a914843667.md)^ GetLinkedConnectorElement()  
