...
---  
    ...
    public static ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> GetMergedParts(
    	[Part](1ee04db6-195f-58fa-a245-5a2f2d404200.md) part
    )  
...
---  
    ...
    Public Shared Function GetMergedParts ( _
    	part As [Part](1ee04db6-195f-58fa-a245-5a2f2d404200.md) _
...
---  
    ...
    public:
    static ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ GetMergedParts(
    	[Part](1ee04db6-195f-58fa-a245-5a2f2d404200.md)^ part
    )  
...
part
    Type: [Autodesk.Revit.DB..::..Part](1ee04db6-195f-58fa-a245-5a2f2d404200.md) A merged part. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The specified Part is not a merged part. |
