...
---  
    ...
    public IList<[RebarContainer](61979a57-facc-d97a-7a35-ee04eed59156.md)> GetRebarContainersInHost()  
  
Visual Basic  
---  
      
    
    Public Function GetRebarContainersInHost As IList(Of [RebarContainer](61979a57-facc-d97a-7a35-ee04eed59156.md))  
...
---  
    ...
    public:
    IList<[RebarContainer](61979a57-facc-d97a-7a35-ee04eed59156.md)^>^ GetRebarContainersInHost()  
