...
---  
    ...
    public virtual [CurveByPoints](2df7ab39-1ac0-5803-79fa-b23a959bf8f2.md) this[
    	int index
    ] { get; set; }  
...
---  
    ...
    public:
    virtual property [CurveByPoints](2df7ab39-1ac0-5803-79fa-b23a959bf8f2.md)^ Item[int index] {
    	[CurveByPoints](2df7ab39-1ac0-5803-79fa-b23a959bf8f2.md)^ get (int index);
    	void set (int index, [CurveByPoints](2df7ab39-1ac0-5803-79fa-b23a959bf8f2.md)^ value);
    }  
