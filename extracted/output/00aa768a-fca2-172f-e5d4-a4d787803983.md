...
---  
    ...
    public [Material](2ec33007-7a2a-f86a-009b-d4c5d235a307.md) Material { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property Material As [Material](2ec33007-7a2a-f86a-009b-d4c5d235a307.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [Material](2ec33007-7a2a-f86a-009b-d4c5d235a307.md)^ Material {
    	[Material](2ec33007-7a2a-f86a-009b-d4c5d235a307.md)^ get ();
    	void set ([Material](2ec33007-7a2a-f86a-009b-d4c5d235a307.md)^ value);
    }  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | When setting this property: material cannot be set for annotation categories. |
