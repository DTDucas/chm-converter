...
---  
    ...
    public [OverrideGraphicSettings](eb2bd6b6-b7b2-5452-2070-2dbadb9e068a.md) SetProjectionLineColor(
...
---  
    ...
    public:
    [OverrideGraphicSettings](eb2bd6b6-b7b2-5452-2070-2dbadb9e068a.md)^ SetProjectionLineColor(
    	[Color](3735f9b9-d477-09ea-25bd-67f34134595f.md)^ color
    )  
...
color
    Type: [Autodesk.Revit.DB..::..Color](3735f9b9-d477-09ea-25bd-67f34134595f.md) Value of the projection surface line color for the override. InvalidColorValue means no override is set. 
