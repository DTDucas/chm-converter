...
---  
    ...
    public ICollection<[CurtainCell](97401874-6fa9-eac0-6190-24687861168c.md)> GetCurtainCells()  
  
Visual Basic  
---  
      
    
    Public Function GetCurtainCells As ICollection(Of [CurtainCell](97401874-6fa9-eac0-6190-24687861168c.md))  
...
---  
    ...
    public:
    ICollection<[CurtainCell](97401874-6fa9-eac0-6190-24687861168c.md)^>^ GetCurtainCells()  
