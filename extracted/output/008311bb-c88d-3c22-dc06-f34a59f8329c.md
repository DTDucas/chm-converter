...
---  
    ...
    void OnText(
    	[TextNode](9a06448a-1c82-7fd7-8be7-9113dc1ce86a.md) node
    )  
...
---  
    ...
    Sub OnText ( _
    	node As [TextNode](9a06448a-1c82-7fd7-8be7-9113dc1ce86a.md) _
    )  
...
node
    Type: [Autodesk.Revit.DB..::..TextNode](9a06448a-1c82-7fd7-8be7-9113dc1ce86a.md) An output node that represents a text annotation. 
