...
---  
    ...
    public [PerformanceAdviserRuleId](3cd02844-a37b-9a93-e926-7d7f32450839.md) GetRuleId(
    	int index
    )  
...
---  
    ...
    Public Function GetRuleId ( _
    	index As Integer _
    ) As [PerformanceAdviserRuleId](3cd02844-a37b-9a93-e926-7d7f32450839.md)  
...
---  
    ...
    public:
    [PerformanceAdviserRuleId](3cd02844-a37b-9a93-e926-7d7f32450839.md)^ GetRuleId(
    	int index
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The index is outside of acceptable range. |
