...
---  
    ...
    public void Open(
    	IList<[WorksetId](8bece327-c269-8101-b4c2-38632f593fe6.md)> worksetsToOpen
    )  
...
---  
    ...
    Public Sub Open ( _
    	worksetsToOpen As IList(Of [WorksetId](8bece327-c269-8101-b4c2-38632f593fe6.md)) _
    )  
...
worksetsToOpen
    Type: System.Collections.Generic..::..IList<(Of <(<'[WorksetId](8bece327-c269-8101-b4c2-38632f593fe6.md)>)>)> The group of user-created worksets to open. Non-user-created worksets and invalid workset ids will be ignored. 
