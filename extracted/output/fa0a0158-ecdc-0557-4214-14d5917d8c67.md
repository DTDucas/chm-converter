...
---  
    ...
    public static string GetLabelFor(
    	[PipeLossMethodType](d6f70bd4-d74c-23b8-002b-0caf388731fd.md) pipeLossMethodType,
...
---  
    ...
    Public Shared Function GetLabelFor ( _
    	pipeLossMethodType As [PipeLossMethodType](d6f70bd4-d74c-23b8-002b-0caf388731fd.md), _
...
pipeLossMethodType
    Type: [Autodesk.Revit.DB.Plumbing..::..PipeLossMethodType](d6f70bd4-d74c-23b8-002b-0caf388731fd.md) The PipeLossMethodType to get the user-visible name. 

doc
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document from which to get the PipeLossMethodType. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when information for the input PipeLossMethodType cannot be found. |
