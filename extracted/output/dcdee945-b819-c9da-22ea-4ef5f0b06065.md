...
**Namespace:** [Autodesk.Revit.DB.Visual](f5a10581-6ac2-be19-0e32-f87d05bc8b83.md)**Assembly:** RevitAPI (in RevitAPI.dll) Version: 24.0.0.0 (24.0.0.0)**Since:** 2019 
...
---  
    ...
    public [AssetProperty](7be89499-d011-ab43-4715-0ee6f9335970.md) Get(
    	int index
    )  
...
---  
    ...
    public:
    [AssetProperty](7be89499-d011-ab43-4715-0ee6f9335970.md)^ Get(
    	int index
    )  
