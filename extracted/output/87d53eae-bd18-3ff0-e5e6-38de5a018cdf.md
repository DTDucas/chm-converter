...
---  
    ...
    public void SetNamingRule(
    	IList<[TableCellCombinedParameterData](f2303148-6e5e-d143-3725-3ac12c04ea86.md)> namingRule
    )  
...
---  
    ...
    Public Sub SetNamingRule ( _
    	namingRule As IList(Of [TableCellCombinedParameterData](f2303148-6e5e-d143-3725-3ac12c04ea86.md)) _
    )  
...
namingRule
    Type: System.Collections.Generic..::..IList<(Of <(<'[TableCellCombinedParameterData](f2303148-6e5e-d143-3725-3ac12c04ea86.md)>)>)> The naming rule. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The namingRule is empty or contains illegal characters. |
