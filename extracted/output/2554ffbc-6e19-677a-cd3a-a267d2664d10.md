...
---  
    ...
    public [CircuitLoadCalculationMethod](d3ce255f-f1a1-7b52-a48c-320314213632.md) CircuitLoadCalculationMethod { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property CircuitLoadCalculationMethod As [CircuitLoadCalculationMethod](d3ce255f-f1a1-7b52-a48c-320314213632.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [CircuitLoadCalculationMethod](d3ce255f-f1a1-7b52-a48c-320314213632.md) CircuitLoadCalculationMethod {
    	[CircuitLoadCalculationMethod](d3ce255f-f1a1-7b52-a48c-320314213632.md) get ();
    	void set ([CircuitLoadCalculationMethod](d3ce255f-f1a1-7b52-a48c-320314213632.md) value);
    }  
