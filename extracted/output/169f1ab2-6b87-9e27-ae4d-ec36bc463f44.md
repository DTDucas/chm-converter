...
---  
    ...
    public [ScheduleSortGroupField](526680eb-ea68-35a7-b0c5-d63459fac04d.md) GetSortGroupField(
    	int index
    )  
...
---  
    ...
    Public Function GetSortGroupField ( _
    	index As Integer _
    ) As [ScheduleSortGroupField](526680eb-ea68-35a7-b0c5-d63459fac04d.md)  
...
---  
    ...
    public:
    [ScheduleSortGroupField](526680eb-ea68-35a7-b0c5-d63459fac04d.md)^ GetSortGroupField(
    	int index
    )  
