...
---  
    ...
    public event EventHandler<[DisplayingOptionsDialogEventArgs](b803dfe4-f87c-ec59-a04c-89900c74bd10.md)> DisplayingOptionsDialog  
  
Visual Basic  
---  
      
    
    Public Event DisplayingOptionsDialog As EventHandler(Of [DisplayingOptionsDialogEventArgs](b803dfe4-f87c-ec59-a04c-89900c74bd10.md))  
...
---  
    ...
    public:
     event EventHandler<[DisplayingOptionsDialogEventArgs](b803dfe4-f87c-ec59-a04c-89900c74bd10.md)^>^ DisplayingOptionsDialog {
    	void add (EventHandler<[DisplayingOptionsDialogEventArgs](b803dfe4-f87c-ec59-a04c-89900c74bd10.md)^>^ value);
    	void remove (EventHandler<[DisplayingOptionsDialogEventArgs](b803dfe4-f87c-ec59-a04c-89900c74bd10.md)^>^ value);
    }  
