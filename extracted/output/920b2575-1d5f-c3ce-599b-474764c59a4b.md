...
---  
    ...
    public static bool CheckGroundPlane(
    	...
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) groundPlaneId
    )  
...
---  
    ...
    Public Shared Function CheckGroundPlane ( _
    	...
    	groundPlaneId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) _
    ) As Boolean  
...
groundPlaneId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The element id to be checked to confirm that it is suitable to be a ground plane (i.e., that it is a level) or that it is invalidElementId. Setting ground plane with invalidElementId will lead to the ground plane being "reset". 
