...
---  
    ...
    public [SchemaBuilder](e74f9357-cc3c-558e-73b8-38ce6d247869.md) SetSchemaName(
    	string schemaName
    )  
...
---  
    ...
    public:
    [SchemaBuilder](e74f9357-cc3c-558e-73b8-38ce6d247869.md)^ SetSchemaName(
    	String^ schemaName
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The parameter schemaName is not acceptable for naming Extensible Storage objects. |
