...
---  
    ...
    public IList<[FailureMessage](d0795bd6-f092-90f2-5c2c-3876e616454c.md)> ExecuteRules(
    	...
    	IList<[PerformanceAdviserRuleId](3cd02844-a37b-9a93-e926-7d7f32450839.md)> rules
    )  
...
---  
    ...
    Public Function ExecuteRules ( _
    	...
    	rules As IList(Of [PerformanceAdviserRuleId](3cd02844-a37b-9a93-e926-7d7f32450839.md)) _
...
rules
    Type: System.Collections.Generic..::..IList<(Of <(<'[PerformanceAdviserRuleId](3cd02844-a37b-9a93-e926-7d7f32450839.md)>)>)> Ids of rules to be executed. 
