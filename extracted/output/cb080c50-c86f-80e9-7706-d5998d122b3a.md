...
---  
    ...
    public [DisplayStyle](c12fdb48-6127-0e0e-0fdc-9f370beb74ca.md) DisplayStyle { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property DisplayStyle As [DisplayStyle](c12fdb48-6127-0e0e-0fdc-9f370beb74ca.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [DisplayStyle](c12fdb48-6127-0e0e-0fdc-9f370beb74ca.md) DisplayStyle {
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: DisplayStyle cannot be set to Undefined. -or- When setting this property: DisplayStyle of Drafting Views can be set only to Wireframe or HLR |
...
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | When setting this property: DisplayStyle cannot be modified. -or- When setting this property: This view does not contain display-related properties. |
