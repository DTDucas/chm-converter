...
**Namespace:** [Autodesk.Revit.DB.IFC](b823fafb-1ba1-896b-4097-142c2817ce74.md)**Assembly:** RevitAPIIFC (in RevitAPIIFC.dll) Version: 24.0.0.0 (24.0.0.0)**Since:** 2022 
...
---  
    ...
    public IDictionary<string, IList<[IFCAnyHandle](8b893943-70fa-94bf-90be-1523d516ecb3.md)>> GetPresentationLayerAssignments()  
  
Visual Basic  
---  
      
    
    Public Function GetPresentationLayerAssignments As IDictionary(Of String, IList(Of [IFCAnyHandle](8b893943-70fa-94bf-90be-1523d516ecb3.md)))  
...
---  
    ...
    public:
    IDictionary<String^, IList<[IFCAnyHandle](8b893943-70fa-94bf-90be-1523d516ecb3.md)^>^>^ GetPresentationLayerAssignments()  
