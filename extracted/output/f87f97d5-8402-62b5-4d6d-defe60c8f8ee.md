...
---  
    ...
    public [Document](ab1718f9-45fb-b3d3-827e-32ff81cf929c.md) Create { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property Create As [Document](ab1718f9-45fb-b3d3-827e-32ff81cf929c.md)
    	Get  
...
---  
    ...
    public:
    property [Document](ab1718f9-45fb-b3d3-827e-32ff81cf929c.md)^ Create {
    	[Document](ab1718f9-45fb-b3d3-827e-32ff81cf929c.md)^ get ();
    }  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when the current document is family document. |
