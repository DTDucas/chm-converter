...
---  
    ...
    public [FailureDefinitionId](b6ada360-a6fe-ebb6-b095-d74b37ade9bf.md) GetFailureDefinitionId()  
  
Visual Basic  
---  
      
    
    Public Function GetFailureDefinitionId As [FailureDefinitionId](b6ada360-a6fe-ebb6-b095-d74b37ade9bf.md)  
...
---  
    ...
    public:
    [FailureDefinitionId](b6ada360-a6fe-ebb6-b095-d74b37ade9bf.md)^ GetFailureDefinitionId()  
