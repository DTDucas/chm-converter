...
---  
    ...
    public IList<[TableCellCombinedParameterData](f2303148-6e5e-d143-3725-3ac12c04ea86.md)> GetNamingRule()  
  
Visual Basic  
---  
      
    
    Public Function GetNamingRule As IList(Of [TableCellCombinedParameterData](f2303148-6e5e-d143-3725-3ac12c04ea86.md))  
...
---  
    ...
    public:
    IList<[TableCellCombinedParameterData](f2303148-6e5e-d143-3725-3ac12c04ea86.md)^>^ GetNamingRule()  
