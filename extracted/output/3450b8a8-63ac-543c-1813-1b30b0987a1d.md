...
---  
    ...
    public static IList<[FabricationConfigurationInfo](c4977168-c9d5-73a7-328c-902330e638c7.md)> GetAllFabricationConfigurations()  
  
Visual Basic  
---  
      
    
    Public Shared Function GetAllFabricationConfigurations As IList(Of [FabricationConfigurationInfo](c4977168-c9d5-73a7-328c-902330e638c7.md))  
...
---  
    ...
    public:
    static IList<[FabricationConfigurationInfo](c4977168-c9d5-73a7-328c-902330e638c7.md)^>^ GetAllFabricationConfigurations()  
