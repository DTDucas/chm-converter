...
---  
    ...
    public IList<[IntegerRange](89a36389-2694-4d88-d3eb-906cafde1619.md)> GetNumbers(
    	string partition
    )  
...
---  
    ...
    ) As IList(Of [IntegerRange](89a36389-2694-4d88-d3eb-906cafde1619.md))  
...
---  
    ...
    public:
    IList<[IntegerRange](89a36389-2694-4d88-d3eb-906cafde1619.md)^>^ GetNumbers(
    	String^ partition
    )  
