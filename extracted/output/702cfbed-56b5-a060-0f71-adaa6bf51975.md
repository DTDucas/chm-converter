...
---  
    ...
    public void SetFieldOrder(
    	IList<[ScheduleFieldId](e437cc01-b976-fe8a-225a-1a0024171fae.md)> fieldIds
    )  
...
---  
    ...
    Public Sub SetFieldOrder ( _
    	fieldIds As IList(Of [ScheduleFieldId](e437cc01-b976-fe8a-225a-1a0024171fae.md)) _
    )  
...
fieldIds
    Type: System.Collections.Generic..::..IList<(Of <(<'[ScheduleFieldId](e437cc01-b976-fe8a-225a-1a0024171fae.md)>)>)> The field IDs in a new order. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | fieldIds does not contain exactly the same field IDs as this ScheduleDefinition currently contains. |
