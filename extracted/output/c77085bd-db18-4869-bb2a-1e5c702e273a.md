...
---  
    ...
    public [RebarShapeDrivenAccessor](6d2f77e7-bbe2-5bd5-723a-bf27c3df1a65.md) GetShapeDrivenAccessor()  
  
Visual Basic  
---  
      
    
    Public Function GetShapeDrivenAccessor As [RebarShapeDrivenAccessor](6d2f77e7-bbe2-5bd5-723a-bf27c3df1a65.md)  
...
---  
    ...
    public:
    [RebarShapeDrivenAccessor](6d2f77e7-bbe2-5bd5-723a-bf27c3df1a65.md)^ GetShapeDrivenAccessor()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This method applies only to shape driven rebar. |
