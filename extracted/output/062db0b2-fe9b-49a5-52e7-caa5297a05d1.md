...
---  
    ...
    public static [PartMaker](ec5be0eb-bf10-0f05-83a4-77daa2cfb0fd.md) CreateMergedPart(
...
---  
    ...
    public:
    static [PartMaker](ec5be0eb-bf10-0f05-83a4-77daa2cfb0fd.md)^ CreateMergedPart(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ partIds
    )  
...
partIds
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> The elements that the merged part will be created from. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | One or more element ids was not suitable for merging with the others. Specified elements should all be Parts, report the same material, creation and demolition phases, and have contiguous geometry. |
