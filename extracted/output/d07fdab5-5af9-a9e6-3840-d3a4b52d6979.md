...
---  
    ...
    public IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)> GetCurvesForBrowser()  
  
Visual Basic  
---  
      
    
    Public Function GetCurvesForBrowser As IList(Of [Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md))  
...
---  
    ...
    public:
    IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^>^ GetCurvesForBrowser()  
