...
---  
    ...
    public [DuctLossMethodType](e97d37df-4991-fa1b-ab8e-deff5b8d0c56.md) AssignedDuctLossMethod { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property AssignedDuctLossMethod As [DuctLossMethodType](e97d37df-4991-fa1b-ab8e-deff5b8d0c56.md)
    	Get  
...
---  
    ...
    public:
    property [DuctLossMethodType](e97d37df-4991-fa1b-ab8e-deff5b8d0c56.md) AssignedDuctLossMethod {
    	[DuctLossMethodType](e97d37df-4991-fa1b-ab8e-deff5b8d0c56.md) get ();
    }  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when the connector's domain is not DomainHvac. Thrown when the connector is not in family instance. |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown on failure to get duct loss method. |
