...
---  
    ...
    public [WallSweepOrientation](c290c137-1e53-8d4e-588a-f52d8a62122c.md) WallSweepOrientation { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property WallSweepOrientation As [WallSweepOrientation](c290c137-1e53-8d4e-588a-f52d8a62122c.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [WallSweepOrientation](c290c137-1e53-8d4e-588a-f52d8a62122c.md) WallSweepOrientation {
    	[WallSweepOrientation](c290c137-1e53-8d4e-588a-f52d8a62122c.md) get ();
    	void set ([WallSweepOrientation](c290c137-1e53-8d4e-588a-f52d8a62122c.md) value);
    }  
