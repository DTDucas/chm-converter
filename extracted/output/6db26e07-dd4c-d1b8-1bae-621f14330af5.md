...
---  
    ...
    public IList<[ScheduleFilter](a5dfec9f-1efd-b507-d079-eabcbf5032f8.md)> GetFilters()  
  
Visual Basic  
---  
      
    
    Public Function GetFilters As IList(Of [ScheduleFilter](a5dfec9f-1efd-b507-d079-eabcbf5032f8.md))  
...
---  
    ...
    public:
    IList<[ScheduleFilter](a5dfec9f-1efd-b507-d079-eabcbf5032f8.md)^>^ GetFilters()  
