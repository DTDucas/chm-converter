...
---  
    ...
    public IList<[CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)> CopyCurveLoopsInSketch()  
  
Visual Basic  
---  
      
    
    Public Function CopyCurveLoopsInSketch As IList(Of [CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md))  
...
---  
    ...
    public:
    IList<[CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)^>^ CopyCurveLoopsInSketch()  
