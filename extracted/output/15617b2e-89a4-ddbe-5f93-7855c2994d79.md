...
---  
    ...
    public void SetNonControlledTemplateParameterIds(
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> newSet
    )  
...
---  
    ...
    Public Sub SetNonControlledTemplateParameterIds ( _
    	newSet As ICollection(Of [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)) _
    )  
...
newSet
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> The parameter ids that should not be marked to be included. 

# Remarks

This should be a subset of the parameters returned by [GetTemplateParameterIds()()()()](64761c8c-ed01-65b6-2b05-ebd7b02acd77.md) (other parameters will be ignored). 
