...
---  
    ...
    public static bool CheckBuildingEnvelope(
    	[gbXMLExportBuildingEnvelope](38b227f5-0d59-fef1-c617-a9ee57c80ff5.md) determinationMethod
    )  
...
---  
    ...
    Public Shared Function CheckBuildingEnvelope ( _
    	determinationMethod As [gbXMLExportBuildingEnvelope](38b227f5-0d59-fef1-c617-a9ee57c80ff5.md) _
    ) As Boolean  
...
determinationMethod
    Type: [Autodesk.Revit.DB.Analysis..::..gbXMLExportBuildingEnvelope](38b227f5-0d59-fef1-c617-a9ee57c80ff5.md) The building envelope determination method to be checked. 
