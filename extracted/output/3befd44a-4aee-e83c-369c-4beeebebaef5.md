...
---  
    ...
    public static [DGNExportOptions](deca8dc2-439f-9567-9c60-70961b3f7c14.md) GetPredefinedOptions(
...
---  
    ...
    Public Shared Function GetPredefinedOptions ( _
    	...
    	setup As String _
    ) As [DGNExportOptions](deca8dc2-439f-9567-9c60-70961b3f7c14.md)  
...
---  
    ...
    public:
    static [DGNExportOptions](deca8dc2-439f-9567-9c60-70961b3f7c14.md)^ GetPredefinedOptions(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	String^ setup
    )  
...
document
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) A Revit project document to retrieve the setup from. 
