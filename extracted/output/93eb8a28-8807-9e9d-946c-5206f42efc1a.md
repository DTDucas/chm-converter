...
---  
    ...
    public void SetViewDisplayModel(
    	[ViewDisplayModel](9864e320-a160-dd24-23f6-a30c482a8e5f.md) viewDisplayModel
    )  
...
---  
    ...
    Public Sub SetViewDisplayModel ( _
    	viewDisplayModel As [ViewDisplayModel](9864e320-a160-dd24-23f6-a30c482a8e5f.md) _
    )  
...
viewDisplayModel
    Type: [Autodesk.Revit.DB..::..ViewDisplayModel](9864e320-a160-dd24-23f6-a30c482a8e5f.md) View display model settings to set. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The silhouette line style id is not a valid line style to apply to the view. |
