...
---  
    ...
    public [AreaBasedLoadBoundaryLineData](52959c6a-9d31-222c-3133-e373047095a9.md) GetAreaBasedLoadBoundaryLineData()  
  
Visual Basic  
---  
      
    
    Public Function GetAreaBasedLoadBoundaryLineData As [AreaBasedLoadBoundaryLineData](52959c6a-9d31-222c-3133-e373047095a9.md)  
...
---  
    ...
    public:
    [AreaBasedLoadBoundaryLineData](52959c6a-9d31-222c-3133-e373047095a9.md)^ GetAreaBasedLoadBoundaryLineData()  
