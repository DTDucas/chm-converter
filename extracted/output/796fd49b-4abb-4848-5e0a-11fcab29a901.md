...
---  
    ...
    public:
    property bool AllowsVisibilityControl[[View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)^ view] {
    	bool get ([View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)^ view);
    }  
  
#### Parameters

view
    Type: [Autodesk.Revit.DB..::..View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)The view where visibility control might be allowed.
