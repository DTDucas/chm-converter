...
---  
    ...
    public [RebarConstraintsManager](32fe1ec6-ddb3-feac-f18c-8683b054f639.md) GetRebarConstraintsManager()  
  
Visual Basic  
---  
      
    
    Public Function GetRebarConstraintsManager As [RebarConstraintsManager](32fe1ec6-ddb3-feac-f18c-8683b054f639.md)  
...
---  
    ...
    public:
    [RebarConstraintsManager](32fe1ec6-ddb3-feac-f18c-8683b054f639.md)^ GetRebarConstraintsManager()  
  
# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The Rebar element does not have external constraints that can be edited. |
