...
---  
    ...
    public event EventHandler<[ElementTypeDuplicatingEventArgs](a507c83d-21c0-badf-ee5d-f5e4c76886a8.md)> ElementTypeDuplicating  
  
Visual Basic  
---  
      
    
    Public Event ElementTypeDuplicating As EventHandler(Of [ElementTypeDuplicatingEventArgs](a507c83d-21c0-badf-ee5d-f5e4c76886a8.md))  
...
---  
    ...
    public:
     event EventHandler<[ElementTypeDuplicatingEventArgs](a507c83d-21c0-badf-ee5d-f5e4c76886a8.md)^>^ ElementTypeDuplicating {
    	void add (EventHandler<[ElementTypeDuplicatingEventArgs](a507c83d-21c0-badf-ee5d-f5e4c76886a8.md)^>^ value);
    	void remove (EventHandler<[ElementTypeDuplicatingEventArgs](a507c83d-21c0-badf-ee5d-f5e4c76886a8.md)^>^ value);
    }  
