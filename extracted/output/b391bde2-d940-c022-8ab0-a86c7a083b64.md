...
---  
    ...
    public void SetParameterValue(
    	...
    	[ParameterValue](366521ef-ecc2-c3e3-feb5-81b3bbd8df0c.md) pValue
    )  
...
---  
    ...
    Public Sub SetParameterValue ( _
    	...
    	pValue As [ParameterValue](366521ef-ecc2-c3e3-feb5-81b3bbd8df0c.md) _
    )  
...
parameterId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) Parameter id. 

pValue
    Type: [Autodesk.Revit.DB..::..ParameterValue](366521ef-ecc2-c3e3-feb5-81b3bbd8df0c.md) New value for the parameter. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | parameterId does not identify a valid parameter of this subelement. -or- The parameter parameterId is not modifiable for this subelement. |
