...
---  
    ...
    public void SetControlPointsAndWeights(
    	IList<[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)> ctrlPoints,
    	[DoubleArray](affa884a-e272-c81a-1fb6-7325edc4f620.md) weights
    )  
...
---  
    ...
    Public Sub SetControlPointsAndWeights ( _
    	ctrlPoints As IList(Of [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)), _
    	weights As [DoubleArray](affa884a-e272-c81a-1fb6-7325edc4f620.md) _
    )  
...
weights
    Type: [Autodesk.Revit.DB..::..DoubleArray](affa884a-e272-c81a-1fb6-7325edc4f620.md)
