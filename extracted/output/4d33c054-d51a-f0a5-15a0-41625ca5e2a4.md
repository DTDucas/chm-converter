...
handle
    Type: [Autodesk.Revit.DB.Structure..::..RebarConstrainedHandle](08b4c4a3-3bb9-0801-9cc8-cd5420a306d9.md) The RebarConstrainedHandle to be highlighted in all views. 

constraint
    Type: [Autodesk.Revit.DB.Structure..::..RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md) The RebarConstraint to be highlighted in all views. 
