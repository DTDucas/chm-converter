...
---  
    ...
    [RenderNodeAction](39f98799-628b-8d65-765c-ca86949ce7ed.md) OnCurve(
    	[CurveNode](f46bbf24-04d0-a4c0-f694-adb30f3db8ea.md) node
    )  
...
---  
    ...
    Function OnCurve ( _
    	node As [CurveNode](f46bbf24-04d0-a4c0-f694-adb30f3db8ea.md) _
...
node
    Type: [Autodesk.Revit.DB..::..CurveNode](f46bbf24-04d0-a4c0-f694-adb30f3db8ea.md) An output node that represents a Curve. 
