...
---  
    ...
    public static [BasicFileInfo](475edc09-cee7-6ff1-a0fa-4e427a56262a.md) Extract(
    	string file
    )  
...
---  
    ...
    Public Shared Function Extract ( _
    	file As String _
    ) As [BasicFileInfo](475edc09-cee7-6ff1-a0fa-4e427a56262a.md)  
...
---  
    ...
    public:
    static [BasicFileInfo](475edc09-cee7-6ff1-a0fa-4e427a56262a.md)^ Extract(
    	String^ file
    )  
...
| [Autodesk.Revit.Exceptions..::..FileArgumentNotFoundException](ca9ccaa9-ed08-d40d-31a7-1af3ad2dcb84.md) | The file doesn't exist. |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The file is a newer format file where the structure of the BasicFileInfo storage has changed, or the file is saved in very old version of Revit without basic file data. |
