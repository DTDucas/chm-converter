...
---  
    ...
    public void RemoveWireType(
    	[WireType](f4d1a1cc-6968-251b-9692-247dc3ff6cff.md) wireType
    )  
...
---  
    ...
    Public Sub RemoveWireType ( _
    	wireType As [WireType](f4d1a1cc-6968-251b-9692-247dc3ff6cff.md) _
    )  
...
wireType
    Type: [Autodesk.Revit.DB.Electrical..::..WireType](f4d1a1cc-6968-251b-9692-247dc3ff6cff.md)

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Wire type can be removed only if it is not used, otherwise an exception will be thrown. |
