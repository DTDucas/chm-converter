...
---  
    ...
    public static [ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) GetBuiltInCategoryTypeId(
...
---  
    ...
    public:
    static [ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md)^ GetBuiltInCategoryTypeId(
    	[BuiltInCategory](ba1c5b30-242f-5fdc-8ea9-ec3b61e6e722.md) categoryId
    )  
...
categoryId
    Type: [Autodesk.Revit.DB..::..BuiltInCategory](ba1c5b30-242f-5fdc-8ea9-ec3b61e6e722.md) The built-in category. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | categoryId is not a valid built-in category. See Category.IsBuiltInCategoryValid(BuiltInCategory). |
