...
|  | [AreItemFilesLoaded](bdedf16d-79ae-abd0-9052-697366004b19.md) | Checks if the fabrication item files have been loaded. |
...
|  | [CanUnloadItemFiles](eaece08e-f3cf-3bd6-489e-19d8cf8e8b1f.md) | Checks if the fabrication item files are already in use and should not be unloaded. |
...
|  | [GetItemFolders](d283e079-1113-f185-e9c0-d40fada72391.md) | Gets a list of every fabrication item folder in the fabrication item folder structure. |
...
|  | [LoadItemFiles](d7aa286a-d55d-46da-b654-0c175f433abc.md) | Loads the specified fabrication item files into the project. |
|  | [LoadServices](893d7a24-0fd6-410f-2459-99c3b16fbfe0.md) | Loads the specified fabrication services into the project. |
...
|  | [SetServicesToLoad](bafcf7a1-c1c1-e908-9d80-31f71a7b6c86.md) | Sets the services which are to be loaded or not next time reloadConfiguration is called. If a service is not included but is currently loaded then it will be unloaded then. |
|  | ToString | Returns a string that represents the current object. (Inherited from Object.) |
|  | [UnloadItemFiles](3343cdd7-7050-0e6f-c294-936a3a9c7e03.md) | Unload the specified fabrication item files from the project. |
|  | [UnloadServices](65e9d8c8-0371-8397-3a50-ec155e189999.md) | Unload the specified fabrication services from the project. |
