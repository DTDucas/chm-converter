...
---  
    ...
    public [MEPAnalyticalSegment](64b45968-97cf-a797-09a6-4583ad9069f7.md) GetSegmentById(
    	int segmentId
    )  
...
---  
    ...
    public:
    [MEPAnalyticalSegment](64b45968-97cf-a797-09a6-4583ad9069f7.md)^ GetSegmentById(
    	int segmentId
    )  
