...
---  
    ...
    public [LeadersPresentationMode](c5c35015-1763-6017-7a06-e6f3710e57d3.md) LeadersPresentationMode { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property LeadersPresentationMode As [LeadersPresentationMode](c5c35015-1763-6017-7a06-e6f3710e57d3.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [LeadersPresentationMode](c5c35015-1763-6017-7a06-e6f3710e57d3.md) LeadersPresentationMode {
    	[LeadersPresentationMode](c5c35015-1763-6017-7a06-e6f3710e57d3.md) get ();
    	void set ([LeadersPresentationMode](c5c35015-1763-6017-7a06-e6f3710e57d3.md) value);
    }  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: The LeadersPresentationMode LeadersPresentationMode.ShowOnlyOne or LeadersPresentationMode.ShowSpecificLeaders can't be set to a tag with only one leader. |
...
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The IndependentTag object does not have a tag behavior. -or- When setting this property: For this tag leaders are not allowed. |
