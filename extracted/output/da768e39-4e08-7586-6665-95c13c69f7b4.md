...
---  
    ...
    public [LinePattern](a2de5c67-d9be-760b-638a-579500216874.md) GetLinePattern()  
  
Visual Basic  
---  
      
    
    Public Function GetLinePattern As [LinePattern](a2de5c67-d9be-760b-638a-579500216874.md)  
...
---  
    ...
    public:
    [LinePattern](a2de5c67-d9be-760b-638a-579500216874.md)^ GetLinePattern()  
