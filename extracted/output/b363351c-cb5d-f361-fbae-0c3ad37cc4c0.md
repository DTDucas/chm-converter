...
---  
    ...
    public event EventHandler<[ThemeChangedEventArgs](5525aa02-cbb1-145a-07ff-cccd62ef932d.md)> ThemeChanged  
  
Visual Basic  
---  
      
    
    Public Event ThemeChanged As EventHandler(Of [ThemeChangedEventArgs](5525aa02-cbb1-145a-07ff-cccd62ef932d.md))  
...
---  
    ...
    public:
     event EventHandler<[ThemeChangedEventArgs](5525aa02-cbb1-145a-07ff-cccd62ef932d.md)^>^ ThemeChanged {
    	void add (EventHandler<[ThemeChangedEventArgs](5525aa02-cbb1-145a-07ff-cccd62ef932d.md)^>^ value);
    	void remove (EventHandler<[ThemeChangedEventArgs](5525aa02-cbb1-145a-07ff-cccd62ef932d.md)^>^ value);
    }  
