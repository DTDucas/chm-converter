...
---  
    ...
    public static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md) CreateEnumeration(
    	string value
    )  
...
---  
    ...
    public:
    static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md)^ CreateEnumeration(
    	String^ value
    )  
