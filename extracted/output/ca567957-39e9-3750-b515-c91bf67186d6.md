...
---  
    ...
    public static [ExportDGNSettings](3df10700-a305-dba7-fc4a-5afb5387256c.md) FindByName(
...
---  
    ...
    public:
    static [ExportDGNSettings](3df10700-a305-dba7-fc4a-5afb5387256c.md)^ FindByName(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ aDoc, 
    	String^ name
    )  
...
aDoc
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) A Revit document to retrieve the specified pre-defined exporting settings for DGN. 
