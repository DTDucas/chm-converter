...
---  
    ...
    public:
    property [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ Basis[int idx] {
    	[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ get (int idx);
    	void set (int idx, [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ value);
    }  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | Thrown when the given index is larger than 2 in the getter and setter. |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when the transform is internally marked as read-only. |
