...
---  
    ...
    public [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) SaveToProjectAsImage(
    	[ImageExportOptions](c2e823a1-6eb0-2bf3-f07b-ed46d8f7b70a.md) options
    )  
...
---  
    ...
    Public Function SaveToProjectAsImage ( _
    	options As [ImageExportOptions](c2e823a1-6eb0-2bf3-f07b-ed46d8f7b70a.md) _
...
---  
    ...
    public:
    [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ SaveToProjectAsImage(
    	[ImageExportOptions](c2e823a1-6eb0-2bf3-f07b-ed46d8f7b70a.md)^ options
    )  
...
options
    Type: [Autodesk.Revit.DB..::..ImageExportOptions](c2e823a1-6eb0-2bf3-f07b-ed46d8f7b70a.md) The options which govern the image creation. 
