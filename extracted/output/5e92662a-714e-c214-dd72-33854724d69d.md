...
---  
    ...
    public [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md) GetFirstProfilePoint()  
  
Visual Basic  
---  
      
    
    Public Function GetFirstProfilePoint As [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)  
...
---  
    ...
    public:
    [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ GetFirstProfilePoint()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This surface element does not use a point to define the first profile. |
