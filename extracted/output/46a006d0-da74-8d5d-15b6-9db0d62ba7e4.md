...
---  
    ...
    public static [LevelAssociationData](f5cae466-48f8-7dfe-a9e4-4aede0db27a3.md) GetLevelAssociationData(
...
---  
    ...
    ) As [LevelAssociationData](f5cae466-48f8-7dfe-a9e4-4aede0db27a3.md)  
...
---  
    ...
    public:
    static [LevelAssociationData](f5cae466-48f8-7dfe-a9e4-4aede0db27a3.md)^ GetLevelAssociationData(
    	[Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)^ element
    )  
...
element
    Type: [Autodesk.Revit.DB..::..Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) The element from which we try to obtain LevelAssociationData. 
