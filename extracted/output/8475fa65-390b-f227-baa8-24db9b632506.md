...
---  
    ...
    public static [IFamilyLoadOptions](d447ed92-74e1-2125-dd0a-38a5ae85ce53.md) GetRevitUIFamilyLoadOptions()  
  
Visual Basic  
---  
      
    
    Public Shared Function GetRevitUIFamilyLoadOptions As [IFamilyLoadOptions](d447ed92-74e1-2125-dd0a-38a5ae85ce53.md)  
...
---  
    ...
    public:
    static [IFamilyLoadOptions](d447ed92-74e1-2125-dd0a-38a5ae85ce53.md)^ GetRevitUIFamilyLoadOptions()  
  
# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown if this API method is invoked in UI less mode |
