...
openFromCloudCallback
    Type: [Autodesk.Revit.DB..::..IOpenFromCloudCallback](266c8a04-c451-539d-8885-1626b131931d.md) Callback function that allow caller to handle cases when conflicts happen during opening a cloud document. Make no sense when opening a non-cloud document. 
