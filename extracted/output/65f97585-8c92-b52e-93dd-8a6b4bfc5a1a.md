...
If trueTruetruetrue (True in Visual Basic), all exported views and sheets will be exported into one PDF file, whose file name would be specified by [FileName](26f04248-487f-bb5a-d04a-95c7b63a4394.md). If falseFalsefalsefalse (False in Visual Basic), each exported view and sheet will have its own PDF file created, whose file name would be generated with [!:NamingRule]. 
