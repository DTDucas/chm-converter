...
---  
    ...
    public [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md) GetHookPlaneNormalForBarIdx(
    	int end,
...
---  
    ...
    public:
    [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ GetHookPlaneNormalForBarIdx(
    	int end, 
    	int barPositionIndex
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | barPositionIndex is not in the range [ 0, NumberOfBarPositions-1 ]. -or- Invalid end. |
