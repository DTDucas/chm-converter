...
---  
    ...
    public IList<[Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)> PickElementsByRectangle(
    	string statusPrompt
    )  
...
---  
    ...
    ) As IList(Of [Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md))  
...
---  
    ...
    public:
    IList<[Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)^>^ PickElementsByRectangle(
    	String^ statusPrompt
    )  
