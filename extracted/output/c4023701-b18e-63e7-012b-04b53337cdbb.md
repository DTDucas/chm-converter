...
---  
    ...
    public [AnalysisDisplayStyleColorSettingsType](5f1e5c03-407b-53fc-8902-1228734907ff.md) ColorSettingsType { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property ColorSettingsType As [AnalysisDisplayStyleColorSettingsType](5f1e5c03-407b-53fc-8902-1228734907ff.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [AnalysisDisplayStyleColorSettingsType](5f1e5c03-407b-53fc-8902-1228734907ff.md) ColorSettingsType {
    	[AnalysisDisplayStyleColorSettingsType](5f1e5c03-407b-53fc-8902-1228734907ff.md) get ();
    	void set ([AnalysisDisplayStyleColorSettingsType](5f1e5c03-407b-53fc-8902-1228734907ff.md) value);
    }  
