...
---  
    ...
    public event EventHandler<[ViewExportedEventArgs](d0e95c70-c5f4-8b12-2f7a-5279ba667948.md)> ViewExported  
  
Visual Basic  
---  
      
    
    Public Event ViewExported As EventHandler(Of [ViewExportedEventArgs](d0e95c70-c5f4-8b12-2f7a-5279ba667948.md))  
...
---  
    ...
    public:
     event EventHandler<[ViewExportedEventArgs](d0e95c70-c5f4-8b12-2f7a-5279ba667948.md)^>^ ViewExported {
    	void add (EventHandler<[ViewExportedEventArgs](d0e95c70-c5f4-8b12-2f7a-5279ba667948.md)^>^ value);
    	void remove (EventHandler<[ViewExportedEventArgs](d0e95c70-c5f4-8b12-2f7a-5279ba667948.md)^>^ value);
    }  
