...
---  
    ...
    public [OverrideGraphicSettings](eb2bd6b6-b7b2-5452-2070-2dbadb9e068a.md) SetSurfaceTransparency(
    	int transparency
    )  
...
---  
    ...
    public:
    [OverrideGraphicSettings](eb2bd6b6-b7b2-5452-2070-2dbadb9e068a.md)^ SetSurfaceTransparency(
    	int transparency
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Transparency must be greater than 0 and less than 100. |
