...
---  
    ...
    public [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) GroundPlaneLevelId { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property GroundPlaneLevelId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ GroundPlaneLevelId {
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: the element level is not a valid Ground Plane Level element. |
