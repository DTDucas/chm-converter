...
---  
    ...
    public static [CableTray](86d92fdc-69d4-ce86-5222-8cc2a8073132.md) Create(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) document,
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) cabletrayType,
...
---  
    ...
    Public Shared Function Create ( _
    	...
    	cabletrayType As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md), _
    ...
    ) As [CableTray](86d92fdc-69d4-ce86-5222-8cc2a8073132.md)  
...
---  
    ...
    public:
    static [CableTray](86d92fdc-69d4-ce86-5222-8cc2a8073132.md)^ Create(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ cabletrayType, 
    	[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ startPoint, 
    	[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ endPoint, 
...
cabletrayType
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The cable tray type. This must be a cable tray type accepted by isValidCableTrayType(). If the input cable tray type is InvalidElementId, the default cable tray type from the document will be used. 

startPoint
    Type: [Autodesk.Revit.DB..::..XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md) The start point of the cable tray location line. 

endPoint
    Type: [Autodesk.Revit.DB..::..XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md) The end point of the cable tray location line. 

levelId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The element id of the level which this cable tray based. If the input level id is invalidElementId = -1, the nearest level will be used. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | This cable tray type is invalid. -or- This level id is invalid. -or- The points of startPoint and endPoint are too close: for MEPCurve, the minimum length is 1/10 inch. |
