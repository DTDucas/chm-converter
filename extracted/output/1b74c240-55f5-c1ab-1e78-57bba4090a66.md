...
---  
    ...
    public IList<[ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)> GetInputPoints()  
  
Visual Basic  
---  
      
    
    Public Function GetInputPoints As IList(Of [ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md))  
...
---  
    ...
    public:
    IList<[ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)^>^ GetInputPoints()  
