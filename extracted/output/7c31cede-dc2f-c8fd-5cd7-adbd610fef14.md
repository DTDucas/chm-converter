...
---  
    ...
    public [RebarShapeSegment](4fd9ba08-b5a3-39c8-9666-fc0a105615c6.md) GetSegment(
    	int segmentIndex
    )  
...
---  
    ...
    ) As [RebarShapeSegment](4fd9ba08-b5a3-39c8-9666-fc0a105615c6.md)  
...
---  
    ...
    public:
    [RebarShapeSegment](4fd9ba08-b5a3-39c8-9666-fc0a105615c6.md)^ GetSegment(
    	int segmentIndex
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | segmentIndex is not between 0 and NumberOfSegments. |
