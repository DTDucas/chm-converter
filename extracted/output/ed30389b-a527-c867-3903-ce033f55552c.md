...
---  
    ...
    public [FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md) AddMapField(
    	string fieldName,
    	Type keyType,
    	Type valueType
    )  
...
---  
    ...
    public:
    [FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md)^ AddMapField(
    	String^ fieldName, 
    	Type^ keyType, 
    	Type^ valueType
    )  
...
| [Autodesk.Revit.Exceptions..::..ArgumentsInconsistentException](05972c68-fa6d-3a83-d720-ad84fbc4780f.md) | The combination of key and value types is not supported. |
