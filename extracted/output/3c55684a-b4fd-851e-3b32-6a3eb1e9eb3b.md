...
---  
    ...
    public [Transform](58dd01c8-b3fc-7142-e4f3-c524079a282d.md) GetProjectionToSheetTransform()  
  
Visual Basic  
---  
      
    
    Public Function GetProjectionToSheetTransform As [Transform](58dd01c8-b3fc-7142-e4f3-c524079a282d.md)  
...
---  
    ...
    public:
    [Transform](58dd01c8-b3fc-7142-e4f3-c524079a282d.md)^ GetProjectionToSheetTransform()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The viewport is not on a sheet. -or- The viewport does not have transforms. |
