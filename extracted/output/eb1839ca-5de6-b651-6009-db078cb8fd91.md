...
---  
    ...
    public [RebarCoverType](b90685db-d2c5-aecb-ff1f-425ca2e5fae9.md) GetCommonCoverType()  
  
Visual Basic  
---  
      
    
    Public Function GetCommonCoverType As [RebarCoverType](b90685db-d2c5-aecb-ff1f-425ca2e5fae9.md)  
...
---  
    ...
    public:
    [RebarCoverType](b90685db-d2c5-aecb-ff1f-425ca2e5fae9.md)^ GetCommonCoverType()  
