...
---  
    ...
    public static bool CanMirrorElements(
    	...
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> elemIds
    )  
...
---  
    ...
    Public Shared Function CanMirrorElements ( _
    	...
    	elemIds As ICollection(Of [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)) _
    ) As Boolean  
...
ADoc
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document where the elements reside. 

elemIds
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> The elements identified by id. 
