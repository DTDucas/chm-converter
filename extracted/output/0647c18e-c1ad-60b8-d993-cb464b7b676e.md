...
---  
    ...
    public [FailureHandlingOptions](c03bb2e5-f679-bf24-4e87-08b3c3a08385.md) SetFailuresPreprocessor(
    	[IFailuresPreprocessor](053c6262-d958-b1b6-44b7-35d0d83b5a43.md) preprocessor
    )  
...
---  
    ...
    Public Function SetFailuresPreprocessor ( _
    	preprocessor As [IFailuresPreprocessor](053c6262-d958-b1b6-44b7-35d0d83b5a43.md) _
...
---  
    ...
    public:
    [FailureHandlingOptions](c03bb2e5-f679-bf24-4e87-08b3c3a08385.md)^ SetFailuresPreprocessor(
    	[IFailuresPreprocessor](053c6262-d958-b1b6-44b7-35d0d83b5a43.md)^ preprocessor
    )  
...
preprocessor
    Type: [Autodesk.Revit.DB..::..IFailuresPreprocessor](053c6262-d958-b1b6-44b7-35d0d83b5a43.md) The callback to be invoked in the beginning of failure processing. 
