...
---  
    ...
    public virtual [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) NewProjectDocument(
...
---  
    ...
    public:
    virtual [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ NewProjectDocument(
    	String^ templateFileName
    )  
...
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | If the new project document cannot be created. |
