...
---  
    ...
    public void RemoveDistributionSysType(
    	[DistributionSysType](03754b33-fd20-b19b-a718-6dc2eeccd76c.md) distributionSysType
    )  
...
---  
    ...
    Public Sub RemoveDistributionSysType ( _
    	distributionSysType As [DistributionSysType](03754b33-fd20-b19b-a718-6dc2eeccd76c.md) _
    )  
...
distributionSysType
    Type: [Autodesk.Revit.DB.Electrical..::..DistributionSysType](03754b33-fd20-b19b-a718-6dc2eeccd76c.md)

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Distribution system type can be removed only if it is not currently assigned to any devices, otherwise an exception will be thrown. |
