...
---  
    ...
    public StructuralAsset(
    	string name,
    	[StructuralAssetClass](f62eea04-3d37-6450-9d5b-52627d3e677b.md) structuralAssetClass
    )  
...
---  
    ...
    Public Sub New ( _
    	name As String, _
    	structuralAssetClass As [StructuralAssetClass](f62eea04-3d37-6450-9d5b-52627d3e677b.md) _
    )  
...
structuralAssetClass
    Type: [Autodesk.Revit.DB..::..StructuralAssetClass](f62eea04-3d37-6450-9d5b-52627d3e677b.md) The type of structural material that this asset will describe. 
