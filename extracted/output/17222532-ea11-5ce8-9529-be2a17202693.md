...
---  
    ...
    public [FlowDirectionType](f32da4fd-b137-448c-0636-693f983c2b48.md) AssignedFlowDirection { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property AssignedFlowDirection As [FlowDirectionType](f32da4fd-b137-448c-0636-693f983c2b48.md)
    	Get  
...
---  
    ...
    public:
    property [FlowDirectionType](f32da4fd-b137-448c-0636-693f983c2b48.md) AssignedFlowDirection {
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when the connector is not in a family instance. Thrown when the connector's domain is not DomainHvac or DomainPiping. |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown on failure to get assigned flow direction. |
