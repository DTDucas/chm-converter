...
---  
    ...
    public static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md) CreateDoubleOfType(
    	double value,
    	string typeName
    )  
...
---  
    ...
    public:
    static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md)^ CreateDoubleOfType(
    	double value, 
    	String^ typeName
    )  
