...
---  
    ...
    public IList<[EvaluatedParameter](1e01eb05-aeae-d72b-5b11-0dbfa45e440b.md)> EvaluateParameterValues(
    	ISet<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> parameterIds
    )  
...
---  
    ...
    Public Function EvaluateParameterValues ( _
    	parameterIds As ISet(Of [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)) _
    ) As IList(Of [EvaluatedParameter](1e01eb05-aeae-d72b-5b11-0dbfa45e440b.md))  
...
---  
    ...
    public:
    IList<[EvaluatedParameter](1e01eb05-aeae-d72b-5b11-0dbfa45e440b.md)^>^ EvaluateParameterValues(
    	ISet<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ parameterIds
    )  
...
parameterIds
    Type: System.Collections.Generic..::..ISet<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> Parameter IDs with which the ParameterValue to be retrieved. 

#### Return Value

List of [EvaluatedParameter](1e01eb05-aeae-d72b-5b11-0dbfa45e440b.md) of the element, which does not include those that cannot be retrieved but are passed in through parameterIds. 
