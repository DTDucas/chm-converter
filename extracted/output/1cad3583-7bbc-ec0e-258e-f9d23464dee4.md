...
---  
    ...
    public static bool CheckBuildingOperatingSchedule(
    	[gbXMLBuildingOperatingSchedule](67ffcea7-1ebd-78c2-d8f3-b6cc5c3595d2.md) buildingOperatingSchedule
    )  
...
---  
    ...
    Public Shared Function CheckBuildingOperatingSchedule ( _
    	buildingOperatingSchedule As [gbXMLBuildingOperatingSchedule](67ffcea7-1ebd-78c2-d8f3-b6cc5c3595d2.md) _
    ) As Boolean  
...
buildingOperatingSchedule
    Type: [Autodesk.Revit.DB.Analysis..::..gbXMLBuildingOperatingSchedule](67ffcea7-1ebd-78c2-d8f3-b6cc5c3595d2.md) The building operating schedule to be checked. 
