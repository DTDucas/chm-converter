...
---  
    ...
    public IList<[LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md)> GetCutLayerModifiers()  
  
Visual Basic  
---  
      
    
    Public Function GetCutLayerModifiers As IList(Of [LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md))  
...
---  
    ...
    public:
    IList<[LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md)^>^ GetCutLayerModifiers()  
