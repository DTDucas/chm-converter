...
---  
    ...
    public class ConduitSizes : IEnumerable<[ConduitSize](4271b827-6390-ab67-036a-305101a712b5.md)>, 
    	IDisposable  
...
---  
    ...
    Public Class ConduitSizes _
    	Implements IEnumerable(Of [ConduitSize](4271b827-6390-ab67-036a-305101a712b5.md)), IDisposable  
  
Visual C++  
---  
      
    
    public ref class ConduitSizes : IEnumerable<[ConduitSize](4271b827-6390-ab67-036a-305101a712b5.md)^>, 
    	IDisposable  
...
[ConduitSizes Members](8903bddc-5272-aadc-f9d7-eee738164e54.md)
