...
---  
    ...
    public [FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md) SetSubSchemaGUID(
    	Guid guid
    )  
...
---  
    ...
    public:
    [FieldBuilder](13cd8e7c-acc8-af6e-0ae6-a9b77fcd913c.md)^ SetSubSchemaGUID(
    	Guid guid
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The SchemaBuilder has already finished building the Schema. -or- The field type does not utilize SubSchemas. |
