...
---  
    ...
    public [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) ActiveGraphicalView { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property ActiveGraphicalView As [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)
    	Get  
...
---  
    ...
    public:
    property [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)^ ActiveGraphicalView {
