...
---  
    ...
    public void Export(
    	string folder,
    	string name,
    	[ViewScheduleExportOptions](f0bde7ea-ceab-820d-7c55-b09819f21607.md) options
    )  
...
---  
    ...
    Public Sub Export ( _
    	folder As String, _
    	name As String, _
    	options As [ViewScheduleExportOptions](f0bde7ea-ceab-820d-7c55-b09819f21607.md) _
    )  
...
options
    Type: [Autodesk.Revit.DB..::..ViewScheduleExportOptions](f0bde7ea-ceab-820d-7c55-b09819f21607.md) Options that relate to schedule export. 
