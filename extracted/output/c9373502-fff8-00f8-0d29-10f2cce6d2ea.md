...
---  
    ...
    public [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md) GetAnalyticalSpace()  
  
Visual Basic  
---  
      
    
    Public Function GetAnalyticalSpace As [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md)  
...
---  
    ...
    public:
    [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md)^ GetAnalyticalSpace()  
