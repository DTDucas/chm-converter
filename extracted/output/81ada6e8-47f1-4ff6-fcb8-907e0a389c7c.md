...
---  
    ...
    public event EventHandler<[SelectionChangedEventArgs](8a744513-6de0-de55-c44c-bba00b949863.md)> SelectionChanged  
  
Visual Basic  
---  
      
    
    Public Event SelectionChanged As EventHandler(Of [SelectionChangedEventArgs](8a744513-6de0-de55-c44c-bba00b949863.md))  
...
---  
    ...
    public:
     event EventHandler<[SelectionChangedEventArgs](8a744513-6de0-de55-c44c-bba00b949863.md)^>^ SelectionChanged {
    	void add (EventHandler<[SelectionChangedEventArgs](8a744513-6de0-de55-c44c-bba00b949863.md)^>^ value);
    	void remove (EventHandler<[SelectionChangedEventArgs](8a744513-6de0-de55-c44c-bba00b949863.md)^>^ value);
    }  
