...
---  
    ...
    public static string GetLabelForDiscipline(
    	[ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) disciplineTypeId
    )  
...
---  
    ...
    Public Shared Function GetLabelForDiscipline ( _
    	disciplineTypeId As [ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) _
    ) As String  
...
disciplineTypeId
    Type: [Autodesk.Revit.DB..::..ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) Identifier of the discipline. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Discipline must have a definition. |
