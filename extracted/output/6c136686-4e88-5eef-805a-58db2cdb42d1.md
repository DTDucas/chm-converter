...
---  
    ...
    public [ProjectPosition](249111cc-c1f3-d3e1-e7bf-dc791327fd4c.md) NewProjectPosition(
    	double ew,
    	double ns,
    	double elevation,
    	double angle
...
---  
    ...
    public:
    [ProjectPosition](249111cc-c1f3-d3e1-e7bf-dc791327fd4c.md)^ NewProjectPosition(
    	double ew, 
    	double ns, 
    	double elevation, 
    	double angle
