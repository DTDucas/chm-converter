...
---  
    ...
    public [WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md) AddWireMaterialType(
    	string name,
    	[WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md) baseMaterial
    )  
...
---  
    ...
    Public Function AddWireMaterialType ( _
    	name As String, _
    	baseMaterial As [WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md) _
    ) As [WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md)  
...
---  
    ...
    public:
    [WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md)^ AddWireMaterialType(
    	String^ name, 
    	[WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md)^ baseMaterial
    )  
...
baseMaterial
    Type: [Autodesk.Revit.DB.Electrical..::..WireMaterialType](3d05ec79-0289-c6d1-2a13-7e6b07241afd.md)Specify an existing material type which New material will be constructed based on.
