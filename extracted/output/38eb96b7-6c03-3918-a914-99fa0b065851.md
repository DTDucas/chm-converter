...
---  
    ...
    public static [LightGroupManager](46515a1f-01c8-935d-2e42-dc57452d4eb9.md) GetLightGroupManager(
...
---  
    ...
    ) As [LightGroupManager](46515a1f-01c8-935d-2e42-dc57452d4eb9.md)  
...
---  
    ...
    public:
    static [LightGroupManager](46515a1f-01c8-935d-2e42-dc57452d4eb9.md)^ GetLightGroupManager(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document
    )  
...
document
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document the manager is from 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The document is not valid because it is not a project (rvt) document |
