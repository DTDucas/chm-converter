...
---  
    ...
    public IList<[LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md)> GetLayerModifiers()  
  
Visual Basic  
---  
      
    
    Public Function GetLayerModifiers As IList(Of [LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md))  
...
---  
    ...
    public:
    IList<[LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md)^>^ GetLayerModifiers()  
