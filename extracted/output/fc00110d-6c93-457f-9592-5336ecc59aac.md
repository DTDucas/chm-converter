...
---  
    ...
    public [ExportLineweightTableIterator](84d255f3-ffc6-5458-1655-f109db371045.md) GetLineweightTableIterator()  
  
Visual Basic  
---  
      
    
    Public Function GetLineweightTableIterator As [ExportLineweightTableIterator](84d255f3-ffc6-5458-1655-f109db371045.md)  
...
---  
    ...
    public:
    [ExportLineweightTableIterator](84d255f3-ffc6-5458-1655-f109db371045.md)^ GetLineweightTableIterator()  
