...
edge
    Type: [Autodesk.Revit.DB..::..Edge](7155ef49-fcd9-c80a-6232-70189a617bcc.md) One of the edges in the edge loop that defines the new connector location on the planar face. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The face is not a planar face. -or- The edge is not on the planar face. |
