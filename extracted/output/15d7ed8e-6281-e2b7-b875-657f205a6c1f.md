...
---  
    ...
    public virtual [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) NewProjectTemplateDocument(
...
---  
    ...
    public:
    virtual [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ NewProjectTemplateDocument(
    	String^ templateFilename
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | If 'templateFileName' is nullNothingnullptra null reference (Nothing in Visual Basic) or an empty string. |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | If the project template document cannot be created. |
