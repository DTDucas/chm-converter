...
---  
    ...
    public [FamilyInstance](0d2231f8-91e6-794f-92ae-16aad8014b27.md) NewElbowFitting(
...
---  
    ...
    public:
    [FamilyInstance](0d2231f8-91e6-794f-92ae-16aad8014b27.md)^ NewElbowFitting(
    	[Connector](11e07082-b3f2-26a1-de79-16535f44716c.md)^ connector1, 
    	[Connector](11e07082-b3f2-26a1-de79-16535f44716c.md)^ connector2
    )  
...
connector1
    Type: [Autodesk.Revit.DB..::..Connector](11e07082-b3f2-26a1-de79-16535f44716c.md)The first connector to be connected to the elbow.

connector2
    Type: [Autodesk.Revit.DB..::..Connector](11e07082-b3f2-26a1-de79-16535f44716c.md)The second connector to be connected to the elbow.
...
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when the connectors cannot be used for the elbow creation. For example, they cannot be from the same element, they must be of the same domain, and the angle between them must fall within the valid range (typically 2 to 95 degrees). |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when an elbow fitting cannot be created because the angle between the two connectors is too large or too small, the connectors are not close enough together, or the connectors are placed at positions with too high of a tolerance. |
