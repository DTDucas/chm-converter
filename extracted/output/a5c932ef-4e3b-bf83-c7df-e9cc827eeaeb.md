...
---  
    ...
    public bool Link(
    	string file,
    	[DGNImportOptions](81dec13f-8eca-f2eb-bf60-1e206e6d0d98.md) options,
    	[View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) pDBView,
    	out [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) elementId
    )  
...
---  
    ...
    Public Function Link ( _
    	file As String, _
    	options As [DGNImportOptions](81dec13f-8eca-f2eb-bf60-1e206e6d0d98.md), _
    	pDBView As [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md), _
    	<OutAttribute> ByRef elementId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) _
    ) As Boolean  
...
---  
    ...
    bool Link(
    	...
    	[DGNImportOptions](81dec13f-8eca-f2eb-bf60-1e206e6d0d98.md)^ options, 
    	[View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)^ pDBView, 
    	[OutAttribute] [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^% elementId
    )  
...
options
    Type: [Autodesk.Revit.DB..::..DGNImportOptions](81dec13f-8eca-f2eb-bf60-1e206e6d0d98.md) Various import options applicable to the DGN format. If nullNothingnullptra null reference (Nothing in Visual Basic), all options will be set to their respective default values. 
...
elementId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)% The id of linked instance after a successful link. 
...
| [Autodesk.Revit.Exceptions..::..OptionalFunctionalityNotAvailableException](0612a676-b6ba-8c37-2e28-b197438305ab.md) | The DGN Import/Link module is not available in the installed Revit. |
