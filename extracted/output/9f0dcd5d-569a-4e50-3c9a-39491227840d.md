...
---  
    ...
    public [MEPNetworkSegmentData](26acc393-12fd-3d27-ee25-f21c88341190.md) GetSegmentData(
    	int segmentId
    )  
...
---  
    ...
    ) As [MEPNetworkSegmentData](26acc393-12fd-3d27-ee25-f21c88341190.md)  
...
---  
    ...
    public:
    [MEPNetworkSegmentData](26acc393-12fd-3d27-ee25-f21c88341190.md)^ GetSegmentData(
    	int segmentId
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The input must be a valid segment id. |
