...
File name of the PDF when [Combine](65f97585-8c92-b52e-93dd-8a6b4bfc5a1a.md) is trueTruetruetrue (True in Visual Basic). 
...
PDF file extension (".pdf") would be automatically appended to the result file. When [Combine](65f97585-8c92-b52e-93dd-8a6b4bfc5a1a.md) is falseFalsefalsefalse (False in Visual Basic), this would be ignored. 
