...
---  
    ...
    public event EventHandler<[DocumentSynchronizingWithCentralEventArgs](d6859206-10ee-9570-a1a8-98a68f3e1fd9.md)> DocumentSynchronizingWithCentral  
  
Visual Basic  
---  
      
    
    Public Event DocumentSynchronizingWithCentral As EventHandler(Of [DocumentSynchronizingWithCentralEventArgs](d6859206-10ee-9570-a1a8-98a68f3e1fd9.md))  
...
---  
    ...
    public:
     event EventHandler<[DocumentSynchronizingWithCentralEventArgs](d6859206-10ee-9570-a1a8-98a68f3e1fd9.md)^>^ DocumentSynchronizingWithCentral {
    	void add (EventHandler<[DocumentSynchronizingWithCentralEventArgs](d6859206-10ee-9570-a1a8-98a68f3e1fd9.md)^>^ value);
    	void remove (EventHandler<[DocumentSynchronizingWithCentralEventArgs](d6859206-10ee-9570-a1a8-98a68f3e1fd9.md)^>^ value);
    }  
