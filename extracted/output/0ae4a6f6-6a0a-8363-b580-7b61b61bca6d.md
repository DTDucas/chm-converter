...
---  
    ...
    public static [DWGExportOptions](3e510f02-1a4c-3e4f-f923-e96972d03862.md) GetPredefinedOptions(
...
---  
    ...
    Public Shared Function GetPredefinedOptions ( _
    	...
    	setup As String _
    ) As [DWGExportOptions](3e510f02-1a4c-3e4f-f923-e96972d03862.md)  
...
---  
    ...
    public:
    static [DWGExportOptions](3e510f02-1a4c-3e4f-f923-e96972d03862.md)^ GetPredefinedOptions(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	String^ setup
    )  
