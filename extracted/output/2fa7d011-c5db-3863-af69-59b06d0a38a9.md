...
---  
    ...
    public IList<[ExportLayerInfo](88a99694-968a-99f7-870a-f46737bd5927.md)> GetValues()  
  
Visual Basic  
---  
      
    
    Public Function GetValues As IList(Of [ExportLayerInfo](88a99694-968a-99f7-870a-f46737bd5927.md))  
...
---  
    ...
    public:
    IList<[ExportLayerInfo](88a99694-968a-99f7-870a-f46737bd5927.md)^>^ GetValues()  
