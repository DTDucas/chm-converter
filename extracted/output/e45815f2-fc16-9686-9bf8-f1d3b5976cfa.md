...
---  
    ...
    public void SetSortGroupFields(
    	IList<[ScheduleSortGroupField](526680eb-ea68-35a7-b0c5-d63459fac04d.md)> sortGroupFields
    )  
...
---  
    ...
    Public Sub SetSortGroupFields ( _
    	sortGroupFields As IList(Of [ScheduleSortGroupField](526680eb-ea68-35a7-b0c5-d63459fac04d.md)) _
    )  
...
sortGroupFields
    Type: System.Collections.Generic..::..IList<(Of <(<'[ScheduleSortGroupField](526680eb-ea68-35a7-b0c5-d63459fac04d.md)>)>)> The new list of sorting/grouping fields. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The resulting sorting/grouping field count would be greater than 4. -or- A field ID is not the ID of a field in this ScheduleDefinition. -or- A field cannot be used for sorting/grouping. |
