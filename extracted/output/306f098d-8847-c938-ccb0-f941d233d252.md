...
---  
    ...
    public [ExportFontTableIterator](3ecdd8b3-57ff-9ec7-8f48-d381414413de.md) GetFontTableIterator()  
  
Visual Basic  
---  
      
    
    Public Function GetFontTableIterator As [ExportFontTableIterator](3ecdd8b3-57ff-9ec7-8f48-d381414413de.md)  
...
---  
    ...
    public:
    [ExportFontTableIterator](3ecdd8b3-57ff-9ec7-8f48-d381414413de.md)^ GetFontTableIterator()  
