...
---  
    ...
    public void SetHookOrientation(
    	int iEnd,
    	[RebarHookOrientation](e8365754-0811-8d4e-864a-55bf34af3a87.md) hookOrientation
    )  
...
---  
    ...
    Public Sub SetHookOrientation ( _
    	iEnd As Integer, _
    	hookOrientation As [RebarHookOrientation](e8365754-0811-8d4e-864a-55bf34af3a87.md) _
    )  
...
hookOrientation
    Type: [Autodesk.Revit.DB.Structure..::..RebarHookOrientation](e8365754-0811-8d4e-864a-55bf34af3a87.md) Only two values are permitted: Value = Right: The hook is on your right as you stand at the end of the bar, with the bar behind you, taking the bar's normal as "up." Value = Left: The hook is on your left as you stand at the end of the bar, with the bar behind you, taking the bar's normal as "up." 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentOutOfRangeException](60f148c9-ece0-a6bb-4e12-bb4a9c8c8a24.md) | iEnd must be 0 or 1. -or- A value passed for an enumeration argument is not a member of that enumeration |
