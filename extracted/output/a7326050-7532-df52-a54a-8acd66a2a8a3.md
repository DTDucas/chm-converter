...
---  
    ...
    public event EventHandler<[TransferringProjectStandardsEventArgs](ffc4e960-25e8-9edb-f660-d328c57e65d0.md)> TransferringProjectStandards  
  
Visual Basic  
---  
      
    
    Public Event TransferringProjectStandards As EventHandler(Of [TransferringProjectStandardsEventArgs](ffc4e960-25e8-9edb-f660-d328c57e65d0.md))  
...
---  
    ...
    public:
     event EventHandler<[TransferringProjectStandardsEventArgs](ffc4e960-25e8-9edb-f660-d328c57e65d0.md)^>^ TransferringProjectStandards {
    	void add (EventHandler<[TransferringProjectStandardsEventArgs](ffc4e960-25e8-9edb-f660-d328c57e65d0.md)^>^ value);
    	void remove (EventHandler<[TransferringProjectStandardsEventArgs](ffc4e960-25e8-9edb-f660-d328c57e65d0.md)^>^ value);
    }  
