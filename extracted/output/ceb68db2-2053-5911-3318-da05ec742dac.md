...
---  
    ...
    public void SetEndTreatmentTypeId(
    	int end,
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) endTreatmentTypeId
    )  
...
---  
    ...
    Public Sub SetEndTreatmentTypeId ( _
    	...
    	endTreatmentTypeId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) _
    )  
...
endTreatmentTypeId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The id of a EndTreatmentType element, or invalidElementId if the rebar should have no end treatment at the specified end. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | the parameter endTreatmentTypeId is not an EndTreatmentType element. |
...
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | the Rebar end end has a RebarCoupler on it. |
