...
options
    Type: [Autodesk.Revit.DB..::..DWGImportOptions](fcba2c30-7e6d-9ab7-8378-f4c6d5de06bf.md) Various options applicable to the DWG or DXF format. If nullNothingnullptra null reference (Nothing in Visual Basic), all options will be set to their respective default values. 
...
elementId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)% The id of imported instance after a successful import. 
