...
---  
    ...
    public event EventHandler<[DocumentOpenedEventArgs](0c6c3227-ecad-6a5f-c1b1-d08745360637.md)> DocumentOpened  
  
Visual Basic  
---  
      
    
    Public Event DocumentOpened As EventHandler(Of [DocumentOpenedEventArgs](0c6c3227-ecad-6a5f-c1b1-d08745360637.md))  
...
---  
    ...
    public:
     event EventHandler<[DocumentOpenedEventArgs](0c6c3227-ecad-6a5f-c1b1-d08745360637.md)^>^ DocumentOpened {
    	void add (EventHandler<[DocumentOpenedEventArgs](0c6c3227-ecad-6a5f-c1b1-d08745360637.md)^>^ value);
    	void remove (EventHandler<[DocumentOpenedEventArgs](0c6c3227-ecad-6a5f-c1b1-d08745360637.md)^>^ value);
    }  
