...
externallyTaggedGeometry
    Type: [Autodesk.Revit.DB..::..ExternallyTaggedGeometryObject](f9d2835b-5b7d-4e3c-e969-8d1d6d25fedd.md) The externally tagged geometry that should be updated in the DirectShapeType. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The input shape does not satisfy DirectShapeType validation criteria. -or- A previous version of the externally tagged geometry is not present in this DirectShapeType. |
