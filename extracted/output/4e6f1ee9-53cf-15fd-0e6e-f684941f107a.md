...
---  
    ...
    public void GetSegmentEndPoints(
    	int segmentId,
    	int regionId,
    	out [UV](1724be37-059b-91ff-aa74-d1508082f76d.md) end1,
    	out [UV](1724be37-059b-91ff-aa74-d1508082f76d.md) end2
    )  
...
---  
    ...
    Public Sub GetSegmentEndPoints ( _
    	...
    	<OutAttribute> ByRef end1 As [UV](1724be37-059b-91ff-aa74-d1508082f76d.md), _
    	<OutAttribute> ByRef end2 As [UV](1724be37-059b-91ff-aa74-d1508082f76d.md) _
    )  
...
---  
    ...
    void GetSegmentEndPoints(
    	int segmentId, 
    	int regionId, 
    	[OutAttribute] [UV](1724be37-059b-91ff-aa74-d1508082f76d.md)^% end1, 
    	[OutAttribute] [UV](1724be37-059b-91ff-aa74-d1508082f76d.md)^% end2
    )  
...
end1
    Type: [Autodesk.Revit.DB..::..UV](1724be37-059b-91ff-aa74-d1508082f76d.md)% One end point. 

end2
    Type: [Autodesk.Revit.DB..::..UV](1724be37-059b-91ff-aa74-d1508082f76d.md)% The other end point. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The segment id is invalid. |
