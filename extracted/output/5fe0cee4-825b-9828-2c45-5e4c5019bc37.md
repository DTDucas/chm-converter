...
---  
    ...
    void OnLineSegment(
    	[LineSegment](d67cd999-109a-9465-39d0-99bba3e775cf.md) segment
    )  
...
---  
    ...
    Sub OnLineSegment ( _
    	segment As [LineSegment](d67cd999-109a-9465-39d0-99bba3e775cf.md) _
    )  
...
segment
    Type: [Autodesk.Revit.DB..::..LineSegment](d67cd999-109a-9465-39d0-99bba3e775cf.md) A structure describing the line segment. 
