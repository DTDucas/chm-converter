...
---  
    ...
    public IList<[ExternalResourceReference](ffad9c15-8fc9-fbfd-f328-101533f4cf74.md)> GetResources()  
  
Visual Basic  
---  
      
    
    Public Function GetResources As IList(Of [ExternalResourceReference](ffad9c15-8fc9-fbfd-f328-101533f4cf74.md))  
...
---  
    ...
    public:
    IList<[ExternalResourceReference](ffad9c15-8fc9-fbfd-f328-101533f4cf74.md)^>^ GetResources()  
