...
---  
    ...
    public [Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md) LineStyle { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property LineStyle As [Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)^ LineStyle {
    	[Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)^ get ();
    	void set ([Element](eb16114f-69ea-f4de-0d0d-f7388b105a16.md)^ value);
    }  
...
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when regeneration failed. -- or -- Thrown when fail to get line style. |
