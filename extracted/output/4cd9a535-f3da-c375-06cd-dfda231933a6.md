...
---  
    ...
    public [MEPAnalyticalNode](d542aa13-f6a7-087c-9660-b0698d303a0c.md) GetNodeById(
    	int nodeId
    )  
...
---  
    ...
    public:
    [MEPAnalyticalNode](d542aa13-f6a7-087c-9660-b0698d303a0c.md)^ GetNodeById(
    	int nodeId
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The input must be a valid node id. |
