...
---  
    ...
    public [StructuralBehavior](f3f7bac9-221a-2b0e-1465-5b86dd8454b2.md) Behavior { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property Behavior As [StructuralBehavior](f3f7bac9-221a-2b0e-1465-5b86dd8454b2.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [StructuralBehavior](f3f7bac9-221a-2b0e-1465-5b86dd8454b2.md) Behavior {
    	[StructuralBehavior](f3f7bac9-221a-2b0e-1465-5b86dd8454b2.md) get ();
    	void set ([StructuralBehavior](f3f7bac9-221a-2b0e-1465-5b86dd8454b2.md) value);
    }  
