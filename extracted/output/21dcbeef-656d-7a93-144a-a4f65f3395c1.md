...
---  
    ...
    public [GroundConductorSize](922e6d1c-9bde-70c5-774b-a04a941003c1.md) AddGroundConductorSize(
    	long ampacity,
    	string size
    )  
...
---  
    ...
    Public Function AddGroundConductorSize ( _
    	ampacity As Long, _
    	size As String _
    ) As [GroundConductorSize](922e6d1c-9bde-70c5-774b-a04a941003c1.md)  
...
---  
    ...
    public:
    [GroundConductorSize](922e6d1c-9bde-70c5-774b-a04a941003c1.md)^ AddGroundConductorSize(
    	long long ampacity, 
    	String^ size
    )  
