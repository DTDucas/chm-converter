...
---  
    ...
    public IList<[FabricArea](b8e6a637-e069-500d-b7d3-3500e1728681.md)> GetFabricAreasInHost()  
  
Visual Basic  
---  
      
    
    Public Function GetFabricAreasInHost As IList(Of [FabricArea](b8e6a637-e069-500d-b7d3-3500e1728681.md))  
...
---  
    ...
    public:
    IList<[FabricArea](b8e6a637-e069-500d-b7d3-3500e1728681.md)^>^ GetFabricAreasInHost()  
