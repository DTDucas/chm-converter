...
---  
    ...
    public [OverrideGraphicSettings](eb2bd6b6-b7b2-5452-2070-2dbadb9e068a.md) SetProjectionLineWeight(
    	int lineWeight
    )  
...
---  
    ...
    public:
    [OverrideGraphicSettings](eb2bd6b6-b7b2-5452-2070-2dbadb9e068a.md)^ SetProjectionLineWeight(
    	int lineWeight
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Line weight must be a positive integer less than 17 or invalidPenNumber. |
