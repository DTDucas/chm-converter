...
---  
    ...
    public [RebarHookOrientation](e8365754-0811-8d4e-864a-55bf34af3a87.md) GetHookOrientationAtIndex(
...
---  
    ...
    public:
    [RebarHookOrientation](e8365754-0811-8d4e-864a-55bf34af3a87.md) GetHookOrientationAtIndex(
    	int barPositionIndex, 
    	int end
    )  
