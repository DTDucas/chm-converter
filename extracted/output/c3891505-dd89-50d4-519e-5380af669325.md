...
---  
    ...
    void OnPolylineSegments(
    	[PolylineSegments](d268283e-28de-c419-5e1f-7a870603506c.md) segments
    )  
...
---  
    ...
    Sub OnPolylineSegments ( _
    	segments As [PolylineSegments](d268283e-28de-c419-5e1f-7a870603506c.md) _
    )  
...
segments
    Type: [Autodesk.Revit.DB..::..PolylineSegments](d268283e-28de-c419-5e1f-7a870603506c.md) A structure describing the polyline segments. 
