...
---  
    ...
    public virtual [DimensionSegment](36b254a0-3dc5-7bdc-d6b4-986e5d82ddbf.md) this[
    	int index
    ] { get; set; }  
...
---  
    ...
    Public Overridable Property Item ( _
    	index As Integer _
    ) As [DimensionSegment](36b254a0-3dc5-7bdc-d6b4-986e5d82ddbf.md)
    	Get
    	Set  
...
---  
    ...
    public:
    virtual property [DimensionSegment](36b254a0-3dc5-7bdc-d6b4-986e5d82ddbf.md)^ Item[int index] {
    	[DimensionSegment](36b254a0-3dc5-7bdc-d6b4-986e5d82ddbf.md)^ get (int index);
    	void set (int index, [DimensionSegment](36b254a0-3dc5-7bdc-d6b4-986e5d82ddbf.md)^ value);
    }  
