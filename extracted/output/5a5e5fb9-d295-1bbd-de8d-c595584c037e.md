...
---  
    ...
    public ThermalAsset(
    	string name,
    	[ThermalMaterialType](73446ebc-6ebf-855c-aadc-a4d4291cc082.md) materialType
    )  
...
---  
    ...
    Public Sub New ( _
    	name As String, _
    	materialType As [ThermalMaterialType](73446ebc-6ebf-855c-aadc-a4d4291cc082.md) _
    )  
...
materialType
    Type: [Autodesk.Revit.DB..::..ThermalMaterialType](73446ebc-6ebf-855c-aadc-a4d4291cc082.md) The type of thermal material that this asset will describe. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | name is an empty string. -or- name cannot include prohibited characters, such as "{, }, [, ], | , ;, less-than sign, greater-than sign, ?, `, ~". |
