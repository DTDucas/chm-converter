...
facets
    Type: System.Collections.Generic..::..IList<(Of <(<'[PolymeshFacet](a7315aaf-631d-96af-368c-65f86b6c00ef.md)>)>)> The facets to be checked. 

points
    Type: System.Collections.Generic..::..IList<(Of <(<'[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)>)>)> A collection of points. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | There are no points in the input points set. -or- There were not enough points to form a valid region (at least 3 are required), or the points were collinear ignoring elevation. |
