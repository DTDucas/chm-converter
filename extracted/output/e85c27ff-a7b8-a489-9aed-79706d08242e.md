...
---  
    ...
    public static IList<IList<[CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)>> SortCurveLoops(
...
---  
    ...
    ) As IList(Of IList(Of [CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)))  
...
---  
    ...
    public:
    static IList<IList<[CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)^>^>^ SortCurveLoops(
    	IList<[CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)^>^ loops
    )  
