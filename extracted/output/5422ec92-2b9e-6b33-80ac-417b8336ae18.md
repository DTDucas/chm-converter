...
---  
    ...
    public static [CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md) Create(
...
---  
    ...
    public:
    static [CurveLoop](84824924-cb89-9e20-de6e-3461f429dfd6.md)^ Create(
    	IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^>^ curves
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The input curves contains at least one helical curve and is not supported for this operation. -or- Throws if the input curves are not contiguous. |
