...
---  
    ...
    public bool Export(
    	...
    	[FBXExportOptions](faede206-7c81-c13d-b584-a49b56329941.md) options
    )  
...
---  
    ...
    Public Function Export ( _
    	...
    	options As [FBXExportOptions](faede206-7c81-c13d-b584-a49b56329941.md) _
    ) As Boolean  
...
views
    Type: [Autodesk.Revit.DB..::..ViewSet](47b47de2-4234-01e0-af21-64334e2a4a4b.md)Selection of views to be exported.Only 3D views are allowed.

options
    Type: [Autodesk.Revit.DB..::..FBXExportOptions](faede206-7c81-c13d-b584-a49b56329941.md)Options applicable to the FBX format.
...
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when the input views is an empty ViewSet. Thrown if any view in the views is not a 3D view. |
