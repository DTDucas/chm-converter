...
---  
    ...
    public static [AreaLoad](5dc205a9-cafd-911b-6a56-26f2e8bfcdc1.md) Create(
    	...
    	IList<[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)> forceVectors,
...
---  
    ...
    Public Shared Function Create ( _
    	...
    	forceVectors As IList(Of [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)), _
...
forceVectors
    Type: System.Collections.Generic..::..IList<(Of <(<'[XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)>)>)> The array of force vectors applied to the maximum three reference point of the area load. 
