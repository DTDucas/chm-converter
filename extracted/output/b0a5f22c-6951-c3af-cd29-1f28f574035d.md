...
---  
    ...
    public [FilteredElementCollector](263cf06b-98be-6f91-c4da-fb47d01688f3.md) OfClass(
    	Type type
    )  
...
---  
    ...
    public:
    [FilteredElementCollector](263cf06b-98be-6f91-c4da-fb47d01688f3.md)^ OfClass(
    	Type^ type
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The input type is not a subclass of Element. -or- The input type is of an element type that exists in the API, but not in Revit's native object model. |
