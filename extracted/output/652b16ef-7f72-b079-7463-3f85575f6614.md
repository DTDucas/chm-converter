...
---  
    ...
    public [LightGroup](fd876292-9f3a-7a90-dd41-019631baadca.md) CreateGroup(
    	string name
    )  
...
---  
    ...
    Public Function CreateGroup ( _
    	name As String _
    ) As [LightGroup](fd876292-9f3a-7a90-dd41-019631baadca.md)  
...
---  
    ...
    public:
    [LightGroup](fd876292-9f3a-7a90-dd41-019631baadca.md)^ CreateGroup(
    	String^ name
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The name is not valid because it is not unique within this LightGroupManager -or- name cannot include prohibited characters, such as "{, }, [, ], | , ;, less-than sign, greater-than sign, ?, `, ~". |
