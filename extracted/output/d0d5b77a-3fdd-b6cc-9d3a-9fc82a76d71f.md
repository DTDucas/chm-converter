...
---  
    ...
    public void SetSymbolTypeId(
    	[ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) symbolTypeId
    )  
...
---  
    ...
    Public Sub SetSymbolTypeId ( _
    	symbolTypeId As [ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) _
    )  
...
symbolTypeId
    Type: [Autodesk.Revit.DB..::..ForgeTypeId](d9fcf276-9566-de83-2b0b-d89b65ccc8af.md) The symbol identifier. An empty identifier string indicates no symbol. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | symbolTypeId is not a valid symbol for the unit in this FormatOptions. |
