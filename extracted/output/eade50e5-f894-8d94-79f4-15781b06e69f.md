...
---  
    ...
    public static bool CanBeDivisionProfile(
    	...
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) familyDocument
    )  
...
---  
    ...
    Public Shared Function CanBeDivisionProfile ( _
    	...
    	familyDocument As [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) _
    ) As Boolean  
...
familyId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) Element id of the family. 

familyDocument
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document containing the family to be tested. 
