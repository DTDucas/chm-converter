...
---  
    ...
    public BRepBuilder(
    	[BRepType](7006d069-f606-c27a-8c77-30cbdbc263d1.md) geomType
    )  
...
---  
    ...
    Public Sub New ( _
    	geomType As [BRepType](7006d069-f606-c27a-8c77-30cbdbc263d1.md) _
    )  
...
geomType
    Type: [Autodesk.Revit.DB..::..BRepType](7006d069-f606-c27a-8c77-30cbdbc263d1.md) Specifies the expected type of the output geometry. 
