...
---  
    ...
    public [MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md) CurrentConstruction { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property CurrentConstruction As [MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md)^ CurrentConstruction {
    	[MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md)^ get ();
    	void set ([MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md)^ value);
    }  
