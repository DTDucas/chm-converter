...
---  
    ...
    public void PropagateToViews(
    	...
    	ISet<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> parallelViews
    )  
...
---  
    ...
    Public Sub PropagateToViews ( _
    	...
    	parallelViews As ISet(Of [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)) _
    )  
...
parallelViews
    Type: System.Collections.Generic..::..ISet<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> The ids of the specified parallel views. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The datum plane cannot be visible in the view. -or- One ElementId in parallelViews is not valid for extent propagation. |
