...
revitCommandId
    Type: [Autodesk.Revit.UI..::..RevitCommandId](0fb2f851-f469-f739-d6ee-89b40b25c4a2.md)The Revit command id to identify the command handler you want to remove the binding. 
...
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when the given command is not bound with this add-in. |
