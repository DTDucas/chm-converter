...
---  
    ...
    public [ScheduleFilter](a5dfec9f-1efd-b507-d079-eabcbf5032f8.md) GetFilter(
    	int index
    )  
...
---  
    ...
    Public Function GetFilter ( _
    	index As Integer _
    ) As [ScheduleFilter](a5dfec9f-1efd-b507-d079-eabcbf5032f8.md)  
...
---  
    ...
    public:
    [ScheduleFilter](a5dfec9f-1efd-b507-d079-eabcbf5032f8.md)^ GetFilter(
    	int index
    )  
