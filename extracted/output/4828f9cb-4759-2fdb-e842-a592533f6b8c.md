...
---  
    ...
    public [TemporaryViewModes](cf6ecc84-e459-55c5-a4d7-d88ae4033a23.md) TemporaryViewModes { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property TemporaryViewModes As [TemporaryViewModes](cf6ecc84-e459-55c5-a4d7-d88ae4033a23.md)
    	Get  
...
---  
    ...
    public:
    property [TemporaryViewModes](cf6ecc84-e459-55c5-a4d7-d88ae4033a23.md)^ TemporaryViewModes {
    	[TemporaryViewModes](cf6ecc84-e459-55c5-a4d7-d88ae4033a23.md)^ get ();
    }  
