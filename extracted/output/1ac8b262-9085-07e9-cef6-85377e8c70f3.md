...
---  
    ...
    public IList<[UIView](2a070256-00f0-5cab-1412-bee5bbfcfc5e.md)> GetOpenUIViews()  
  
Visual Basic  
---  
      
    
    Public Function GetOpenUIViews As IList(Of [UIView](2a070256-00f0-5cab-1412-bee5bbfcfc5e.md))  
...
---  
    ...
    public:
    IList<[UIView](2a070256-00f0-5cab-1412-bee5bbfcfc5e.md)^>^ GetOpenUIViews()  
