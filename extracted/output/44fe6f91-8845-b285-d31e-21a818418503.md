...
---  
    ...
    public static bool CheckExportComplexity(
    	[gbXMLExportComplexity](f1e171a8-a220-13c0-a088-853f43003bb8.md) exportComplexity
    )  
...
---  
    ...
    Public Shared Function CheckExportComplexity ( _
    	exportComplexity As [gbXMLExportComplexity](f1e171a8-a220-13c0-a088-853f43003bb8.md) _
    ) As Boolean  
...
exportComplexity
    Type: [Autodesk.Revit.DB.Analysis..::..gbXMLExportComplexity](f1e171a8-a220-13c0-a088-853f43003bb8.md) The export complexity to be checked. 
