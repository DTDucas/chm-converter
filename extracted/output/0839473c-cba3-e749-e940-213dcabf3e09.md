...
---  
    ...
    public [RebarShapeVertex](ef7d9a62-94b7-dfde-3175-e3dd616d49f3.md) GetVertex(
    	int vertexIndex
    )  
...
---  
    ...
    ) As [RebarShapeVertex](ef7d9a62-94b7-dfde-3175-e3dd616d49f3.md)  
...
---  
    ...
    public:
    [RebarShapeVertex](ef7d9a62-94b7-dfde-3175-e3dd616d49f3.md)^ GetVertex(
    	int vertexIndex
    )  
