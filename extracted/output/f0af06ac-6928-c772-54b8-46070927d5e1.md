...
**Namespace:** [Autodesk.Revit.DB.IFC](b823fafb-1ba1-896b-4097-142c2817ce74.md)**Assembly:** RevitAPIIFC (in RevitAPIIFC.dll) Version: 24.0.0.0 (24.0.0.0)**Since:** 2023.1 
...
---  
    ...
    public void SetCurrentExportedDocument(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) pDocument
    )  
...
---  
    ...
    Public Sub SetCurrentExportedDocument ( _
    	pDocument As [Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) _
    )  
...
pDocument
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document being processed. 
