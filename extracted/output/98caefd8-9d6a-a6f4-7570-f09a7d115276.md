...
---  
    ...
    public [Category](d390ecf6-e5db-d7c1-d7f2-766c0686e975.md) Parent { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property Parent As [Category](d390ecf6-e5db-d7c1-d7f2-766c0686e975.md)
    	Get  
...
---  
    ...
    public:
    property [Category](d390ecf6-e5db-d7c1-d7f2-766c0686e975.md)^ Parent {
