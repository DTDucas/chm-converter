...
---  
    ...
    public IList<[LightGroup](fd876292-9f3a-7a90-dd41-019631baadca.md)> GetGroups()  
  
Visual Basic  
---  
      
    
    Public Function GetGroups As IList(Of [LightGroup](fd876292-9f3a-7a90-dd41-019631baadca.md))  
...
---  
    ...
    public:
    IList<[LightGroup](fd876292-9f3a-7a90-dd41-019631baadca.md)^>^ GetGroups()  
