...
---  
    ...
    public IList<[RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md)> GetCustomConstraints()  
  
Visual Basic  
---  
      
    
    Public Function GetCustomConstraints As IList(Of [RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md))  
...
---  
    ...
    public:
    IList<[RebarConstraint](748823c8-f059-68c1-d7b5-7cfaba93a445.md)^>^ GetCustomConstraints()  
