...
---  
    ...
    public bool IsLayerValid(
    	int layerIdx,
    	[CompoundStructureLayer](faece83a-6d49-41b0-2713-fe6cfaa5a3b5.md) layer
    )  
...
---  
    ...
    Public Function IsLayerValid ( _
    	...
    	layer As [CompoundStructureLayer](faece83a-6d49-41b0-2713-fe6cfaa5a3b5.md) _
    ) As Boolean  
...
layer
    Type: [Autodesk.Revit.DB..::..CompoundStructureLayer](faece83a-6d49-41b0-2713-fe6cfaa5a3b5.md) The layer to be set. 
