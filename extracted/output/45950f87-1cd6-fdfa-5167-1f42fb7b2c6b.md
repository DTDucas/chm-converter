...
---  
    ...
    public static [PartMaker](ec5be0eb-bf10-0f05-83a4-77daa2cfb0fd.md) DivideParts(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) document,
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> elementIdsToDivide,
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> intersectingReferenceIds,
...
---  
    ...
    Public Shared Function DivideParts ( _
    	...
    	elementIdsToDivide As ICollection(Of [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)), _
    	intersectingReferenceIds As ICollection(Of [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)), _
    ...
    ) As [PartMaker](ec5be0eb-bf10-0f05-83a4-77daa2cfb0fd.md)  
...
---  
    ...
    public:
    static [PartMaker](ec5be0eb-bf10-0f05-83a4-77daa2cfb0fd.md)^ DivideParts(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ elementIdsToDivide, 
    	ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ intersectingReferenceIds, 
    	IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^>^ curveArray, 
...
document
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document containing the parts. 

elementIdsToDivide
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> The elements that will be divided. 

intersectingReferenceIds
    Type: System.Collections.Generic..::..ICollection<(Of <(<'[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)>)>)> Intersecting references that will divide the elements. 

curveArray
    Type: System.Collections.Generic..::..IList<(Of <(<'[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)>)>)> Array of curves that will divide the elements. 

sketchPlaneId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) SketchPlane id for the curves that divide the elements. 
