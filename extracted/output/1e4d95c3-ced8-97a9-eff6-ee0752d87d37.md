...
---  
    ...
    public void Close(
    	IList<[WorksetId](8bece327-c269-8101-b4c2-38632f593fe6.md)> worksetsToClose
    )  
...
---  
    ...
    Public Sub Close ( _
    	worksetsToClose As IList(Of [WorksetId](8bece327-c269-8101-b4c2-38632f593fe6.md)) _
    )  
...
worksetsToClose
    Type: System.Collections.Generic..::..IList<(Of <(<'[WorksetId](8bece327-c269-8101-b4c2-38632f593fe6.md)>)>)> The group of user-created worksets to close. Non-user-created worksets and invalid workset ids will be ignored. 
