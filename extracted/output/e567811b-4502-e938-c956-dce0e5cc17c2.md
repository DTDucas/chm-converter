...
---  
    ...
    public void Save(
    	[SaveOptions](b93277ab-dfb6-a3a3-cfd9-8cee29cee644.md) options
    )  
...
---  
    ...
    Public Sub Save ( _
    	options As [SaveOptions](b93277ab-dfb6-a3a3-cfd9-8cee29cee644.md) _
    )  
...
options
    Type: [Autodesk.Revit.DB..::..SaveOptions](b93277ab-dfb6-a3a3-cfd9-8cee29cee644.md) Options to control the Save operation. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | options.PreviewViewId is not valid for generation of a preview. |
...
| [Autodesk.Revit.Exceptions..::..ForbiddenForDynamicUpdateException](c5b911f6-1e8f-2cd4-6965-286f41221fe0.md) | Save may not be called during dynamic update. |
