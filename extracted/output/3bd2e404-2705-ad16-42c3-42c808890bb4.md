...
---  
    ...
    public [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md) GetRefPoint(
    	int index
    )  
...
---  
    ...
    public:
    [XYZ](c2fd995c-95c0-58fb-f5de-f3246cbc5600.md)^ GetRefPoint(
    	int index
    )  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Thrown when index is out of range. |
