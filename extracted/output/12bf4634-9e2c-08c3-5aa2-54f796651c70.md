...
---  
    ...
    public [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) GetEndTreatmentTypeIdAtIndex(
...
---  
    ...
    public:
    [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ GetEndTreatmentTypeIdAtIndex(
    	int barPositionIndex, 
    	int end
    )  
