...
---  
    ...
    public void AddElectricalLoadArea(
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) electricalLoadAreaId
    )  
...
---  
    ...
    Public Sub AddElectricalLoadArea ( _
    	electricalLoadAreaId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) _
    )  
...
electricalLoadAreaId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The electrical load area id to add. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The id isn't a valid electrical load area. |
