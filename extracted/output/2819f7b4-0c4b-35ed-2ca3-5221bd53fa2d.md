...
---  
    ...
    public IList<[Leader](66228564-d8b8-fc81-454c-e175528f7188.md)> GetLeaders()  
  
Visual Basic  
---  
      
    
    Public Function GetLeaders As IList(Of [Leader](66228564-d8b8-fc81-454c-e175528f7188.md))  
...
---  
    ...
    public:
    IList<[Leader](66228564-d8b8-fc81-454c-e175528f7188.md)^>^ GetLeaders()  
