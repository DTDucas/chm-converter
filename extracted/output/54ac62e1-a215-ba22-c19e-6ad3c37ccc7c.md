...
---  
    ...
    public event EventHandler<[FileExportedEventArgs](8f668506-1f9b-0282-f6df-66428891ad3b.md)> FileExported  
  
Visual Basic  
---  
      
    
    Public Event FileExported As EventHandler(Of [FileExportedEventArgs](8f668506-1f9b-0282-f6df-66428891ad3b.md))  
...
---  
    ...
    public:
     event EventHandler<[FileExportedEventArgs](8f668506-1f9b-0282-f6df-66428891ad3b.md)^>^ FileExported {
    	void add (EventHandler<[FileExportedEventArgs](8f668506-1f9b-0282-f6df-66428891ad3b.md)^>^ value);
    	void remove (EventHandler<[FileExportedEventArgs](8f668506-1f9b-0282-f6df-66428891ad3b.md)^>^ value);
    }  
