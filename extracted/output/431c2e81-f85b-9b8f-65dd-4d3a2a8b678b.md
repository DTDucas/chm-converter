...
---  
    ...
    public virtual [IExternalApplication](196c8712-71de-03e8-b30d-a9625bd626d2.md) this[
    	int index
    ] { get; set; }  
...
---  
    ...
    Public Overridable Property Item ( _
    	index As Integer _
    ) As [IExternalApplication](196c8712-71de-03e8-b30d-a9625bd626d2.md)
    	Get
    	Set  
...
---  
    ...
    public:
    virtual property [IExternalApplication](196c8712-71de-03e8-b30d-a9625bd626d2.md)^ Item[int index] {
    	[IExternalApplication](196c8712-71de-03e8-b30d-a9625bd626d2.md)^ get (int index);
    	void set (int index, [IExternalApplication](196c8712-71de-03e8-b30d-a9625bd626d2.md)^ value);
    }  
