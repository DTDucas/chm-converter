...
---  
    ...
    public [TextNoteType](2991b6af-daf6-463d-3796-8b83fdbd344f.md) TextNoteType { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property TextNoteType As [TextNoteType](2991b6af-daf6-463d-3796-8b83fdbd344f.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [TextNoteType](2991b6af-daf6-463d-3796-8b83fdbd344f.md)^ TextNoteType {
    	[TextNoteType](2991b6af-daf6-463d-3796-8b83fdbd344f.md)^ get ();
    	void set ([TextNoteType](2991b6af-daf6-463d-3796-8b83fdbd344f.md)^ value);
    }  
