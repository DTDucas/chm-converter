...
---  
    ...
    public event EventHandler<[DocumentReloadingLatestEventArgs](0952bb8e-fa8d-382a-ba2b-97bbbc820a99.md)> DocumentReloadingLatest  
  
Visual Basic  
---  
      
    
    Public Event DocumentReloadingLatest As EventHandler(Of [DocumentReloadingLatestEventArgs](0952bb8e-fa8d-382a-ba2b-97bbbc820a99.md))  
...
---  
    ...
    public:
     event EventHandler<[DocumentReloadingLatestEventArgs](0952bb8e-fa8d-382a-ba2b-97bbbc820a99.md)^>^ DocumentReloadingLatest {
    	void add (EventHandler<[DocumentReloadingLatestEventArgs](0952bb8e-fa8d-382a-ba2b-97bbbc820a99.md)^>^ value);
    	void remove (EventHandler<[DocumentReloadingLatestEventArgs](0952bb8e-fa8d-382a-ba2b-97bbbc820a99.md)^>^ value);
    }  
...
Another [DocumentReloadingLatest](f266e021-0f55-3671-f010-4b23128d6ca3.md) event will be raised immediately after latest changes reloading from a central model is finished.
