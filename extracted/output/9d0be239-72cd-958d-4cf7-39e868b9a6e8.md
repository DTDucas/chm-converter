...
---  
    ...
    public void AddLayerModifier(
    	[LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md) layerModifier
    )  
...
---  
    ...
    Public Sub AddLayerModifier ( _
    	layerModifier As [LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md) _
    )  
...
layerModifier
    Type: [Autodesk.Revit.DB..::..LayerModifier](ae7bade6-00b8-698f-d2a4-541905b668e9.md) The project layer modifier. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The separator string contains one or more prohibited characters. -or- The modifier type already exists in the layer info. |
