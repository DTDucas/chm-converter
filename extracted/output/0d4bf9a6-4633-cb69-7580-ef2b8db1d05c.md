...
---  
    ...
    public [TaskDialogResult](bde54cc2-a445-8610-0ced-1851f04eea18.md) Show()  
  
Visual Basic  
---  
      
    
    Public Function Show As [TaskDialogResult](bde54cc2-a445-8610-0ced-1851f04eea18.md)  
...
---  
    ...
    public:
    [TaskDialogResult](bde54cc2-a445-8610-0ced-1851f04eea18.md) Show()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | Thrown when the task dialog is shown out of main thread of Revit or when an extra checkbox and a verification checkbox are enabled at the same time. |
