...
---  
    ...
    public void Print(
    	[View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) viewTemplate
    )  
...
---  
    ...
    Public Sub Print ( _
    	viewTemplate As [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) _
    )  
...
viewTemplate
    Type: [Autodesk.Revit.DB..::..View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)The view template which apply to the view.
