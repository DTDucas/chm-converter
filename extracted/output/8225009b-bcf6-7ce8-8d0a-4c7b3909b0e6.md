...
---  
    ...
    public static void MakeAdaptivePoint(
    	...
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) refPointId,
    	[AdaptivePointType](a766bd98-92b6-ea2f-2544-94acca1ad268.md) type
    )  
...
---  
    ...
    Public Shared Sub MakeAdaptivePoint ( _
    	...
    	refPointId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md), _
    	type As [AdaptivePointType](a766bd98-92b6-ea2f-2544-94acca1ad268.md) _
    )  
...
refPointId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The ReferencePoint id 

type
    Type: [Autodesk.Revit.DB..::..AdaptivePointType](a766bd98-92b6-ea2f-2544-94acca1ad268.md) The Adaptive Point Type 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | The ElementId refPointId does not correspond to a valid ReferencePoint. -or- The Element corresponding to ElementId refPointId does not belong to an Adaptive Family. |
