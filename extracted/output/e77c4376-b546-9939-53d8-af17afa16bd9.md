...
---  
    ...
    public static ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> GetDisplacedElementIds(
...
---  
    ...
    public:
    static ICollection<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ GetDisplacedElementIds(
    	[View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)^ view
    )  
