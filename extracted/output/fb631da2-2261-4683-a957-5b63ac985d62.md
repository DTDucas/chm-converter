...
viewTemplate
    Type: [Autodesk.Revit.DB..::..View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)The view template which apply to the set of views.
...
| [Autodesk.Revit.Exceptions..::..ApplicationException](05012a96-16ea-ace7-6115-b45406dacead.md) | Thrown when at least one view from the view set could not be printed. |
