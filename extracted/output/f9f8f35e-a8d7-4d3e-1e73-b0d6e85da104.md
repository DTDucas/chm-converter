...
---  
    ...
    public static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md) CreateIntegerOfType(
    	int value,
    	string typeName
    )  
...
---  
    ...
    public:
    static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md)^ CreateIntegerOfType(
    	int value, 
    	String^ typeName
    )  
