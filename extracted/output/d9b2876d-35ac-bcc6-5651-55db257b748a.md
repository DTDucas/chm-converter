...
---  
    ...
    public [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md) GetAdjacentAnalyticalSpace()  
  
Visual Basic  
---  
      
    
    Public Function GetAdjacentAnalyticalSpace As [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md)  
...
---  
    ...
    public:
    [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md)^ GetAdjacentAnalyticalSpace()  
