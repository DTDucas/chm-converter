...
---  
    ...
    public IList<[EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md)> GetAnalyticalSpaces()  
  
Visual Basic  
---  
      
    
    Public Function GetAnalyticalSpaces As IList(Of [EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md))  
...
---  
    ...
    public:
    IList<[EnergyAnalysisSpace](cd0567d0-f5e0-a850-6d10-bde911831947.md)^>^ GetAnalyticalSpaces()  
