...
---  
    ...
    public event EventHandler<[ElementTypeDuplicatedEventArgs](7ec2ef50-ea02-2e47-a854-490d00285cd1.md)> ElementTypeDuplicated  
  
Visual Basic  
---  
      
    
    Public Event ElementTypeDuplicated As EventHandler(Of [ElementTypeDuplicatedEventArgs](7ec2ef50-ea02-2e47-a854-490d00285cd1.md))  
...
---  
    ...
    public:
     event EventHandler<[ElementTypeDuplicatedEventArgs](7ec2ef50-ea02-2e47-a854-490d00285cd1.md)^>^ ElementTypeDuplicated {
    	void add (EventHandler<[ElementTypeDuplicatedEventArgs](7ec2ef50-ea02-2e47-a854-490d00285cd1.md)^>^ value);
    	void remove (EventHandler<[ElementTypeDuplicatedEventArgs](7ec2ef50-ea02-2e47-a854-490d00285cd1.md)^>^ value);
    }  
