...
---  
    ...
    public [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) TagViewId { get; set; }  
  
Visual Basic  
---  
      
    
    Public Property TagViewId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)
    	Get
    	Set  
...
---  
    ...
    public:
    property [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ TagViewId {
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | When setting this property: tagViewId is not a valid view for tagging the FabricArea or FabricSheets. |
