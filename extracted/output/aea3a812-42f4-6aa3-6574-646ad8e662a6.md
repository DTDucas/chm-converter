...
---  
    ...
    public void GetSketchCurves(
    	out IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)> curveArray
    )  
...
---  
    ...
    Public Sub GetSketchCurves ( _
    	<OutAttribute> ByRef curveArray As IList(Of [Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)) _
    )  
...
---  
    ...
    void GetSketchCurves(
    	[OutAttribute] IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^>^% curveArray
    )  
  
#### Parameters

curveArray
    Type: System.Collections.Generic..::..IList<(Of <(<'[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)>)>)>% Curves in the sketch. Tags of the curves are consistent with the curve tags used in part keys. 
