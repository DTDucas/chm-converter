...
---  
    ...
    public [DoubleArray](affa884a-e272-c81a-1fb6-7325edc4f620.md) Weights { get; }  
  
Visual Basic  
---  
      
    
    Public ReadOnly Property Weights As [DoubleArray](affa884a-e272-c81a-1fb6-7325edc4f620.md)
    	Get  
...
---  
    ...
    public:
    property [DoubleArray](affa884a-e272-c81a-1fb6-7325edc4f620.md)^ Weights {
