...
---  
    ...
    public [MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md) NewConstruction(
    	string pName
    )  
...
---  
    ...
    public:
    [MEPBuildingConstruction](3468e6dd-c676-cf39-b851-052b3e3a2f95.md)^ NewConstruction(
    	String^ pName
    )  
