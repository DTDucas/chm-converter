...
---  
    ...
    public [SchedulableField](84f03bb5-a9b8-581c-631c-6240b4954099.md) GetSchedulableField()  
  
Visual Basic  
---  
      
    
    Public Function GetSchedulableField As [SchedulableField](84f03bb5-a9b8-581c-631c-6240b4954099.md)  
...
---  
    ...
    public:
    [SchedulableField](84f03bb5-a9b8-581c-631c-6240b4954099.md)^ GetSchedulableField()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InapplicableDataException](dc1a6d15-8923-a1fe-722a-4e976634a519.md) | This ScheduleField is not a schedulable field by type(non-calculated/non-combined-parameter). |
