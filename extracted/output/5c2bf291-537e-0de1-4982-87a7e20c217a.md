...
pGeomArr
    Type: System.Collections.Generic..::..IList<(Of <(<'[GeometryObject](e0f15010-0e19-6216-e2f0-ab7978145daa.md)>)>)> Shape of this object expressed as a collection of GeometryObjects. These will be copied. Shape and Category should be consistent: geometry supplied as shape should be valid for the Category the type object is associated with. The supported types of GeometryObjects are: Solid, Mesh, GeometryInstance, Point, Curve and PolyLine. 
