...
---  
    ...
    public static bool IsCodeSuccess(
    	[LinkLoadResultType](11b095e1-24d9-91b9-ae2e-004f67c94d6e.md) code
    )  
...
---  
    ...
    Public Shared Function IsCodeSuccess ( _
    	code As [LinkLoadResultType](11b095e1-24d9-91b9-ae2e-004f67c94d6e.md) _
    ) As Boolean  
...
code
    Type: [Autodesk.Revit.DB..::..LinkLoadResultType](11b095e1-24d9-91b9-ae2e-004f67c94d6e.md) Load result code to be verified. 
