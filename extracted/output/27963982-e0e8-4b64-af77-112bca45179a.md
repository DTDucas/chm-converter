...
---  
    ...
    public bool IsEqual(
    	[FillGrid](6dfc3e2f-c869-d06e-876e-49c4007f7e59.md) other
    )  
...
---  
    ...
    Public Function IsEqual ( _
    	other As [FillGrid](6dfc3e2f-c869-d06e-876e-49c4007f7e59.md) _
    ) As Boolean  
...
other
    Type: [Autodesk.Revit.DB..::..FillGrid](6dfc3e2f-c869-d06e-876e-49c4007f7e59.md) The fill grid to be compared. 
