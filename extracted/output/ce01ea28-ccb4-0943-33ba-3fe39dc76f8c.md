...
---  
    ...
    public [FailureHandlingOptions](c03bb2e5-f679-bf24-4e87-08b3c3a08385.md) SetForcedModalHandling(
    	bool bFlag
    )  
...
---  
    ...
    public:
    [FailureHandlingOptions](c03bb2e5-f679-bf24-4e87-08b3c3a08385.md)^ SetForcedModalHandling(
    	bool bFlag
    )  
