...
Inserts multiple [IndexPoint](cd53f076-2011-ce3a-f92e-3b384f21b8ec.md) instances into the stream and associated buffer. 
...
---  
    ...
    public void AddPoints(
    	IList<[IndexPoint](cd53f076-2011-ce3a-f92e-3b384f21b8ec.md)> points
    )  
...
---  
    ...
    Public Sub AddPoints ( _
    	points As IList(Of [IndexPoint](cd53f076-2011-ce3a-f92e-3b384f21b8ec.md)) _
    )  
...
points
    Type: System.Collections.Generic..::..IList<(Of <(<'[IndexPoint](cd53f076-2011-ce3a-f92e-3b384f21b8ec.md)>)>)> The points to be inserted. 
