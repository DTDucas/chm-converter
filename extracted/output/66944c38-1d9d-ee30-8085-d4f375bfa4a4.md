...
---  
    ...
    public static [StructuralConnectionHandler](78653026-36f1-6ab3-f2c0-728692c99b3c.md) Create(
    	...
    	IList<[ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)> additionalInputPoints
    )  
...
---  
    ...
    Public Shared Function Create ( _
    	...
    	additionalInputPoints As IList(Of [ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)) _
...
additionalInputPoints
    Type: System.Collections.Generic..::..IList<(Of <(<'[ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)>)>)> The array of points that help define the connection. 
