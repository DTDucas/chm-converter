...
---  
    ...
    public [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) Import(
    	string file,
    	[AXMImportOptions](fa5c85e0-25ea-cc04-2b97-48a3fa989cfc.md) options,
...
---  
    ...
    Public Function Import ( _
    	file As String, _
    	options As [AXMImportOptions](fa5c85e0-25ea-cc04-2b97-48a3fa989cfc.md), _
...
options
    Type: [Autodesk.Revit.DB..::..AXMImportOptions](fa5c85e0-25ea-cc04-2b97-48a3fa989cfc.md) Various import options applicable to the AXM format. If nullNothingnullptra null reference (Nothing in Visual Basic), all options will be set to their respective default values. Import FormIt support Preserve color mode, center-to-center and origin-to-origin placement, other options are not supported. Import FormIt does not support orient to view and this view only option. 
...
| [Autodesk.Revit.Exceptions..::..OptionalFunctionalityNotAvailableException](0612a676-b6ba-8c37-2e28-b197438305ab.md) | The AXM Import/Link module is not available in the installed Revit. |
