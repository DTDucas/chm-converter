...
---  
    ...
    public static [CurveElement](61673852-2d08-003d-e9fd-4be89d533774.md) CreateAreaBasedLoadBoundaryLine(
...
---  
    ...
    public:
    static [CurveElement](61673852-2d08-003d-e9fd-4be89d533774.md)^ CreateAreaBasedLoadBoundaryLine(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^ curve, 
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ levelId
    )  
...
document
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document in which to create the area based load boundary line. 

curve
    Type: [Autodesk.Revit.DB..::..Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md) The curve. 

levelId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The id of level. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | document is not a project document. -or- The input curve is not bound. -or- The curve is degenerate (its length is too close to zero). -or- The ElementId levelId is not a Level. -or- The curve doesn't lie in the plane of the level. |
