...
---  
    ...
    public static IList<[CurveElement](61673852-2d08-003d-e9fd-4be89d533774.md)> CreateAreaBasedLoadBoundaryLines(
...
---  
    ...
    ) As IList(Of [CurveElement](61673852-2d08-003d-e9fd-4be89d533774.md))  
...
---  
    ...
    public:
    static IList<[CurveElement](61673852-2d08-003d-e9fd-4be89d533774.md)^>^ CreateAreaBasedLoadBoundaryLines(
    	[Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md)^ document, 
    	IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^>^ curves, 
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^ levelId
    )  
...
document
    Type: [Autodesk.Revit.DB..::..Document](db03274b-a107-aa32-9034-f3e0df4bb1ec.md) The document in which to create the area based load boundary lines. 

curves
    Type: System.Collections.Generic..::..IList<(Of <(<'[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)>)>)> The curves. 
