...
---  
    ...
    public IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)> GetCustomDistributionPath()  
  
Visual Basic  
---  
      
    
    Public Function GetCustomDistributionPath As IList(Of [Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md))  
...
---  
    ...
    public:
    IList<[Curve](400cc9b6-9ff7-de85-6fd8-c20002209d25.md)^>^ GetCustomDistributionPath()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This RebarFreeFormAccessor doesn't contain a valid rebar reference. -or- This RebarFreeFormAccessor Rebar doesn't contain a valid server GUID. |
