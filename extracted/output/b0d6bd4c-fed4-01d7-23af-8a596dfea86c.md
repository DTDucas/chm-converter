...
---  
    ...
    public static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md) CreateBinary(
    	string value
    )  
...
---  
    ...
    Public Shared Function CreateBinary ( _
    	value As String _
    ) As [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md)  
...
---  
    ...
    public:
    static [IFCData](34762033-771a-ebee-bd69-509c55ae78f0.md)^ CreateBinary(
    	String^ value
    )  
