...
---  
    ...
    public void SetLineStyleId(
    	[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) lineStyleId
    )  
...
---  
    ...
    Public Sub SetLineStyleId ( _
    	lineStyleId As [ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) _
    )  
...
lineStyleId
    Type: [Autodesk.Revit.DB..::..ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md) The line style Id. 

# Exceptions

| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | lineStyleId is not a valid line style Id for a filled region. |
