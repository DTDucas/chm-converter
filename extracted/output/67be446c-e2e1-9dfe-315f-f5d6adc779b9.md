...
---  
    ...
    public [RebarFreeFormAccessor](bf146aa3-f780-646e-c3cd-42e7a61d18e6.md) GetFreeFormAccessor()  
  
Visual Basic  
---  
      
    
    Public Function GetFreeFormAccessor As [RebarFreeFormAccessor](bf146aa3-f780-646e-c3cd-42e7a61d18e6.md)  
...
---  
    ...
    public:
    [RebarFreeFormAccessor](bf146aa3-f780-646e-c3cd-42e7a61d18e6.md)^ GetFreeFormAccessor()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | This method applies only to free form rebar. |
