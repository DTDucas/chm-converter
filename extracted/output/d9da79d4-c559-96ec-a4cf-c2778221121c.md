...
---  
    ...
    public static bool IsValidAsParentInView(
    	...
    	[DisplacementElement](08113547-eaaa-5ec1-5ff1-de609fe7c29c.md) parent
    )  
...
---  
    ...
    Public Shared Function IsValidAsParentInView ( _
    	...
    	parent As [DisplacementElement](08113547-eaaa-5ec1-5ff1-de609fe7c29c.md) _
    ) As Boolean  
...
view
    Type: [Autodesk.Revit.DB..::..View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) A view. 
