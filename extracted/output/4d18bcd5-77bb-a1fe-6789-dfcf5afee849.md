...
---  
    ...
    public IList<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)> Link(
    	string file,
    	[DWFImportOptions](8465ab77-dc06-79c2-4bed-e17a564adb22.md) options
    )  
...
---  
    ...
    Public Function Link ( _
    	file As String, _
    	options As [DWFImportOptions](8465ab77-dc06-79c2-4bed-e17a564adb22.md) _
...
---  
    ...
    public:
    IList<[ElementId](44f3f7b1-3229-3404-93c9-dc5e70337dd6.md)^>^ Link(
    	String^ file, 
    	[DWFImportOptions](8465ab77-dc06-79c2-4bed-e17a564adb22.md)^ options
    )  
...
options
    Type: [Autodesk.Revit.DB..::..DWFImportOptions](8465ab77-dc06-79c2-4bed-e17a564adb22.md) Various link options applicable to the DWF format. 
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..ArgumentException](2e6e4206-97a8-dd4b-df5d-4269f4bb6088.md) | Not a valid file for DWF import (.dwf or.dwfx files are valid). -or- Some of the views are not importable. |
