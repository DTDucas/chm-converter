...
---  
    ...
    public [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md) CreateViewTemplate()  
  
Visual Basic  
---  
      
    
    Public Function CreateViewTemplate As [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)  
...
---  
    ...
    public:
    [View](fb92a4e7-f3a7-ef14-e631-342179b18de9.md)^ CreateViewTemplate()  
...
| Exception | Condition |
| --- | --- |
| [Autodesk.Revit.Exceptions..::..InvalidOperationException](9e715f03-3884-e539-4dd6-8d7545733adc.md) | The view is not valid for view template creation. |
