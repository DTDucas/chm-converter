...
---  
    ...
    public static void SetApplicationMacroSecurityOptions(
    	...
    	[ApplicationMacroOptions](f2e09bb1-8f51-089d-dc36-c76c9a1fb683.md) macroOptions
    )  
...
---  
    ...
    Public Shared Sub SetApplicationMacroSecurityOptions ( _
    	...
    	macroOptions As [ApplicationMacroOptions](f2e09bb1-8f51-089d-dc36-c76c9a1fb683.md) _
    )  
...
macroOptions
    Type: [Autodesk.Revit.DB.Macros..::..ApplicationMacroOptions](f2e09bb1-8f51-089d-dc36-c76c9a1fb683.md) The application macro security options. 
