...
---  
    ...
    public RevitLinkOptions(
    	[RevitLinkOptions](3f710983-5a4d-d515-a633-12b06a419b30.md) other
    )  
...
---  
    ...
    Public Sub New ( _
    	other As [RevitLinkOptions](3f710983-5a4d-d515-a633-12b06a419b30.md) _
    )  
...
other
    Type: [Autodesk.Revit.DB..::..RevitLinkOptions](3f710983-5a4d-d515-a633-12b06a419b30.md)
