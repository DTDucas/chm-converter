...
---  
    ...
    public [ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md) GetInputPoint(
    	Guid id
    )  
...
---  
    ...
    Public Function GetInputPoint ( _
    	id As Guid _
    ) As [ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)  
...
---  
    ...
    public:
    [ConnectionInputPoint](8f40a39a-d5f3-16dc-eada-47f602a780f4.md)^ GetInputPoint(
    	Guid id
    )  
