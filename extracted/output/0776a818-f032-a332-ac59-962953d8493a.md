...
---  
    ...
    public static [ModelPath](40a84c72-e4b8-72ac-2f71-3216c66a11b3.md) ConvertUserVisiblePathToModelPath(
    	string strPath
    )  
...
---  
    ...
    public:
    static [ModelPath](40a84c72-e4b8-72ac-2f71-3216c66a11b3.md)^ ConvertUserVisiblePathToModelPath(
    	String^ strPath
    )  
