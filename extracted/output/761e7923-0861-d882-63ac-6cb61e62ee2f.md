...
---  
    ...
    public [IFCAggregate](06bbeb56-efc6-1810-3111-f8ab4f615da1.md) CreateAggregateAttribute(
    	string name
    )  
...
---  
    ...
    Public Function CreateAggregateAttribute ( _
    	name As String _
    ) As [IFCAggregate](06bbeb56-efc6-1810-3111-f8ab4f615da1.md)  
...
---  
    ...
    public:
    [IFCAggregate](06bbeb56-efc6-1810-3111-f8ab4f615da1.md)^ CreateAggregateAttribute(
    	String^ name
    )  
